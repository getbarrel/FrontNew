        ...
        self.ajaxReviewList
                ...
                .init(function (data) {
                    ...
                    $('.devReviewImgs').click(function () {
                        ...
                        var modal_title = '포토/동영상';

                        if(common.langType == 'english') {
                            modal_title = 'Photo/Movie';
                        }

                        common.util.modal.open('ajax', modal_title, '/popup/reviewImgList/view/' + bbsIx);
                    })
                    $('.devBestPickDetail').on('click', '', function () {
                        var bbsIx = $(this).data('bbsix');
                        var modal_title = 'Best Pick 보기';

                        if(common.langType == 'english') {
                            modal_title = 'Best Pick';
                        }
                        common.util.modal.open('ajax', modal_title, '/popup/reviewImgList/bestView/' + bbsIx);
                    })
                    ...
                    $('.devReviewImgList').click(function () {
                        ...
                        common.util.modal.open('ajax', modal_title, '/popup/reviewImgList/list/' + pid );
                    })
