<?php /* Template_ 2.2.8 2024/03/13 16:49:32 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/brand/application_form_group/application_form_group.htm 000041342 */ 
        ...
        <section class="br__group-info br__group-info--team">
            ...
            <div class="br__group-info__content">
                ...
                <dl class="br__join__list">
                    ...
                    <dd>
                        <div class="join__phone">
                            ...
                            <input class="join__phone-second" type="text" name="mpcs2" id="devMasterPcs2" title="감독자 핸드폰 번호" value="<?php echo $TPL_VAR["explodeMPcs"][ 1]?>" maxlength="4"/>
                            <span class="join__phone-hyphen"></span><!-- join__input -->
                            <input class="join__phone-third" type="text" name="mpcs3" id="devMasterPcs3" title="감독자 핸드폰 번호" value="<?php echo $TPL_VAR["explodeMPcs"][ 2]?>" maxlength="4"/>
                        </div>
                    </dd>
                </dl>
                <dl class="br__join__list">
                    ...
                    <dd>
                        <div class="join__eamil"><!-- join__input -->
                            <input class="email-id" type="text" name="emailMId" id="devMEmailId" value="<?php echo $TPL_VAR["explodeMEmail"][ 0]?>" title="이메일"/>
                            <span>@</span><!-- join__input -->
                            <input class="email-info" type="text" name="emailMHost" id="devMEmailHost" value="<?php echo $TPL_VAR["explodeMEmail"][ 1]?>" title="감독자 이메일"/>
                        </div>
                ...
                <!--dl class="br__join__list">
                    ...
                    <dd>
                        <div class="join__id">
                            <input class="join__input" type="text"  name="zip" id="devZip" value="<?php echo $TPL_VAR["postnum"]?>" readonly title="주소"/>
                        ...
                        <input class="join__address" type="text" name="addr2" id="devAddress2" value="<?php echo $TPL_VAR["address2"]?>" title="상세주소"/>
                    </dd>
                </dl-->
                <dl class="br__join__list">
                    <dt>감독자 사진첨부<em class="star">*</em></dt>
                    <dd class="file-box">
                        <input type="text" id="devMasterFileUrl" class="find-file__name" name="group_master_image_url" title="감독자 사진첨부" value="<?php echo $TPL_VAR["group_master_image_url"]?>">
...
<?php }}?>
                    ...
                    <dl class="br__join__list br__player-info">
                        ...
                        <dd class="team-number">
                            <input type="tel" class="team-number__input js__joininput__number" name="memberCnt" id="devMemberCnt" data-max="25" value="<?php echo $TPL_VAR["member_cnt"]?>" <?php if($TPL_VAR["type"]=='M'){?> readonly<?php }?>><span class="number">명</span>
                            <div class="desc">
                                <p class="desc__list">인원수를 입력하시면 명단을 입력하실 수 있습니다.</p>
                                <p class="desc__list desc-color">1팀 당 구성 인원은 최대 25명입니다. (S그룹 참가자 포함)</p>
...
<?php if($TPL_member_1){$TPL_I1=-1;foreach($TPL_VAR["member"] as $TPL_V1){$TPL_I1++;?>
                        <div class="group-list entry-form__sheet">
                            ...
                            <div class="group-list__inner">
                                <p class="br__group-info__desc"><em class="star">*</em> 표시된 항목은 필수 입력사항 입니다.</p>
                                <dl class="br__join__list">
                                    <dt>이름(실명)<em class="star">*</em></dt>
                                    <dd>
                                        <input class="js__joininput__name devRequire" type="text" name="name[]" value="<?php echo $TPL_V1["name"]?>" title="이름(실명)"/>
                                    </dd>
                                </dl>
                                <div class="br__join__add">
                                    <p class="join-symbol">성별</p>
                                    <div class="br__find-user__label">
                                        <label><input type="radio" name="sex[<?php echo $TPL_I1?>]" value="M" <?php if($TPL_V1["sex"]=='M'||$TPL_V1["sex"]==''){?>checked<?php }?>><span>남성</span></label>
                                        <label><input type="radio" name="sex[<?php echo $TPL_I1?>]" value="F" <?php if($TPL_V1["sex"]=='F'){?>checked<?php }?>><span>여성</span></label>
                                    </div>
                                </div>
                                <div class="br__join__list">
                                    <dt>생년월일<em class="star">*</em><span class="subdesc">(예:830724)</span></dt>
                                    <dd>
                                        <input type="text" class="birthday__input devBirthday devRequire" name="birthday[]" title="생년월일" maxlength="6" value="<?php echo $TPL_V1["birthday"]?>">
                                    </dd>
                                </div>
                                <dl class="br__join__list">
                                    ...
                                    <dd>
                                        <div class="join__phone">
                                            ...
                                            <span class="join__phone-hyphen"></span><!-- join__input -->
                                            <input class="join__phone-second devRequire" type="text" name="pcs2[]" value="<?php echo $TPL_V1["explodePcs"][ 1]?>" title="휴대폰번호" maxlength="4"/>
                                            <span class="join__phone-hyphen"></span><!-- join__input -->
                                            <input class="join__phone-third devRequire" type="text" name="pcs3[]" value="<?php echo $TPL_V1["explodePcs"][ 2]?>" title="휴대폰번호" maxlength="4"/>
                                        </div>
                                    </dd>
                                </dl>
                                <dl class="br__join__list">
                                ...
                                <dl class="br__join__list">
                                    ...
                                    <dd>
                                        <div class="join__eamil">
                                            <input class="join__input email-id" type="text" name="emailId" id="devEmailId" value="<?php echo $TPL_VAR["emailId"]?>" title="이메일"/>
                                            <span>@</span>
                                            <input class="join__input email-info" type="text" name="emailHost" id="devEmailHost" value="<?php echo $TPL_VAR["emailHost"]?>" title="이메일"/>
                                        </div>
                                        <select id="devEmailHostSelect">
                                            <option value="">이메일 선택</option>
...
<?php }}?>
                                ...
                                <dl class="br__join__list">
                                    ...
                                    <dd class="file-box">
                                        <input type="text" class="find-file__name devFileUrl devRequire" name="image_url[]" title="사진첨부" value="<?php echo $TPL_V1["image_url"]?>" readonly>
        ...
        <div class="br__join__terms">
            <ul>
                <li class="br__find-user__label agree-content">
                    <label>
                        <input type="checkbox" data-name="terms01" name="policyUse" data-title="대회 이용약관" id="devPolicyUse" title="대회 이용약관" <?php if($TPL_VAR["use_yn"]=='Y'){?> checked <?php }?>>
        ...
        <div class="group-list entry-form__sheet">
            ...
            <div class="group-list__inner">
                ...
                <dl class="br__join__list">
                    <dt>이름(실명)<em class="star">*</em></dt>
                    <dd>
                        <input class="js__joininput__name devRequire" type="text" name="name[]" title="이름"/>
                    </dd>
                </dl>
                <div class="br__join__add">
                    <p class="join-symbol">성별</p>
                    <div class="br__find-user__label">
                        <label><input type="radio"title="성별" name="sex[#num#]" value="M" checked><span>남성</span></label>
                        <label><input type="radio" title="성별" name="sex[#num#]" value="F"><span>여성</span></label>
                    </div>
                </div>
                <div class="br__join__list">
                    <dt>생년월일<em class="star">*</em><span class="subdesc">(예:830724)</span></dt>
                ...
                <dl class="br__join__list">
                    ...
                    <dd>
                        <div class="join__phone">
                            ...
                            <span class="join__phone-hyphen"></span><!-- join__input -->
                            <input class="join__phone-second devPcs2 devRequire" type="text" name="pcs2[]" value="" title="휴대폰번호"/>
                            <span class="join__phone-hyphen"></span><!-- join__input -->
                            <input class="join__phone-third devPcs3 devRequire" type="text" name="pcs3[]" value="" title="휴대폰번호"/>
                        </div>
                    </dd>
                </dl>
                <!-- 191218 기획수정 - 선수입력폼 이메일 삭제
...
<?php }}?>
                ...
                <dl class="br__join__list">
                    <dt>사진첨부<em class="star">*</em></dt>
                    <dd class="file-box">
                        <input type="text" class="find-file__name devFileUrl devRequire" name="image_url[]" title="사진첨부" value="" readonly>
