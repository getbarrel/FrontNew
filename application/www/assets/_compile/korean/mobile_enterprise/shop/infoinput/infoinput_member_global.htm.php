<?php /* Template_ 2.2.8 2021/11/09 15:38:14 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/shop/infoinput/infoinput_member_global.htm 000020757 */ 
            ...
            <div class="br__tabs">
                <ul class="br__tabs__list">
					...
					<li class="br__tabs__box" data-target="list1">
                        <button type="button" class="br__tabs__btn" data-target="list1" devRecipientTypeSelect="addressOrder">최근 배송지</button>
                    </li>
                    <li class="br__tabs__box" data-target="new">
                        <button type="button" class="br__tabs__btn" data-target="new"  devRecipientTypeSelect="input">새로운 배송지</button>
                    </li>
                </ul>
                <div class="br__tabs__content br__tabs__content--show devRecipientContents" data-target="list">
                    <div class="">
                        <div class="info-addr__recent">
                            ...
                            <button class="info-addr__recent__btn" id="devAddressListButton">배송 주소록</button>
                                ...
                                <li class="info-addr__recent__box devOrderAddress devForbizTpl"  id="devOrderAddressList">
                                    <label class="info-addr__recent__label">
                                        <div class="info-addr__recent__info">
                                            <span class="info-addr__recent__name">{[recipient]} ({[shipping_name]}){[#if isBasic]}<span> - 기본</span>{[/if]}</span>
                            ...
                            <div class="info-addr__recent__select devDeliveryMessageContents">
                                <div class="info-buyer__form info-buyer__form--request">
                                    <div class="info-buyer__form">
                                        <label class="info-buyer__form__label">배송요청사항</label>
                                    </div>
...
<?php }}?>
                        ...
                        <div class="info-buyer__form">
                            <input type="checkbox" id="devBasicAddressBookCheckBox" class="info-buyer__form__check" checked><label for="devBasicAddressBookCheckBox">기본배송지로 설정</label>
                            <br>
                            <input type="checkbox" id="devAddAddressBookCheckBox" class="info-buyer__form__check" checked><label for="devAddAddressBookCheckBox">배송지 목록에 추가</label>
                        </div>
                    </div>
                </div>
            </div>
...
<?php }?>
            <span class="infoinput__toggle__sub">
<?php if($TPL_VAR["langType"]=='korean'){?>
                쿠폰 <span id=""devUseCouponCntView"">0</span>장 / 적립금 <span id=""devUseMileageView"">0</span>원 사용</span>
<?php }else{?>
        ...
        <div class="infoinput__toggle__content">
            <div class="info-benefit">
                <div class="info-benefit__form info-benefit__form--coupon">
                    <label class="info-benefit__form__label">쿠폰 할인 <span>(보유 쿠폰: <?php echo $TPL_VAR["userCouponCnt"]?>장)</span></label>
                    <div class="info-benefit__form__inner">
                        ...
                        <button type="button" id="devUseCouponButton" class="info-benefit__form--coupon__valid">쿠폰 적용</button>
                        <button type="button" id="devCancelCouponButton"  class="info-benefit__form--coupon__cancel">적용 취소</button>
                    </div>
                </div>
...
<?php }else{?>
                        Reward
<?php }?>
                        <span>(사용가능 적립금 <?php echo $TPL_VAR["mileageUnit"]?><?php echo g_price($TPL_VAR["userMileage"])?>)</span>
                    </label>
                    <div class="info-benefit__form__inner">
                        ...
                        <div class="info-benefit__form__btn">
                            ...
                            <label for="devAllUseMileageCheckBox">전체 사용</label>
                        </div>
                    </div>
                </div>
