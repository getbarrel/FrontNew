<?php /* Template_ 2.2.8 2023/07/18 10:19:58 /home/barrel-qa/application/www.bak/assets/mobile_templet/mobile_enterprise/shop/coupon_down/coupon_down.htm 000003263 */ 
$TPL_list_1=empty($TPL_VAR["list"])||!is_array($TPL_VAR["list"])?0:count($TPL_VAR["list"]);?>
<section class="br__coupon-down">
    <!--<div class="coupon">-->
        <p class="br__coupon-down__desc">해당 상품에서 사용 가능한 쿠폰 리스트입니다.</p>
...
<?php if($TPL_V1["isPublished"]){?>
                    <button disabled>다운로드 완료</button>
<?php }else{?>
                    <button devPublishIx="<?php echo $TPL_V1["publish_ix"]?>">쿠폰 다운로드</button>
<?php }?>
                </div>
            </li>
<?php }}?>
