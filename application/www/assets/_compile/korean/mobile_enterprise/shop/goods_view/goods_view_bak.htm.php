<?php /* Template_ 2.2.8 2021/09/17 11:07:13 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/shop/goods_view/goods_view_bak.htm 000100935 */ 
...
<?php if($TPL_VAR["movie"]){?>
                <button class="goods-thumb__play">영상 재생</button>
<?php }?>
            </div>
        ...
        <div class="layer-zoom">
            ...
            <button type="button" class="layer-zoom__close">레이어 닫기</button>
        </div>
    </section>
    <!-- [E] 상품슬라이드 -->
    <!-- [S] 타임세일 -->
<?php if($TPL_VAR["discountView"]){?>
    <section class="br__goods-view__time-sale">
        <div class="time-sale">
            ...
            <p class="time-sale__countdown"><span><?php echo $TPL_VAR["saleTime"]?></span> 후 종료!</p>
        </div>
    </section>
<?php }?>
    <!-- [E] 타임세일 -->
...
<?php }}?>
            ...
            <div class="goods-info__btns">
                ...
                <button class="goods-info__btns__share">공유하기</button>
...
<?php if($TPL_VAR["langType"]=='korean'){?>
                        <li class="layer-share__box">
                            <button class="layer-share__btn layer-share__btn--kakaotalk" shareMode='prd' shareContentId="<?php echo $TPL_VAR["id"]?>" shareTypeText="상품" devsnsshare="kakaotalk">카카오톡</button>
                        </li>
<?php }?>
                        <li class="layer-share__box">
                            <button class="layer-share__btn layer-share__btn--facebook" shareMode='prd' shareContentId="<?php echo $TPL_VAR["id"]?>" shareTypeText="상품" devsnsshare="facebook">페이스북</button>
                        </li>
                        <!--<li class="layer-share__box">-->
                        ...
                        <!--</li>-->
                        <li class="layer-share__box">
                            <button class="layer-share__btn layer-share__btn--twitter" shareMode='prd' shareContentId="<?php echo $TPL_VAR["id"]?>" shareTypeText="상품" devsnsshare="twitter">트위터</button>
                        </li>
                        <li class="layer-share__box">
                            <button class="layer-share__btn layer-share__btn--url" value="<?php echo $TPL_VAR["snsShareUrl"]?>" devsnsshare="url-copy">URL복사</button>
                        </li>
                    </ul>
                </div>
            </div>
...
<?php if($TPL_VAR["couponApplyCnt"]> 0){?>
            <div class="goods-info__coupon">
                <button class="goods-info__coupon__btn" id="devCouponDown" data-pid="<?php echo $TPL_VAR["pid"]?>">할인 쿠폰 다운로드</button>
            </div>
<?php }?>
            <!-- 혜택내역 layer content -->
...
<?php if($TPL_VAR["product_type"]== 0&&$TPL_VAR["add_info"]!=''){?>
            <div class="goods-info__color">
                <h4 class="goods-info__color__title">색상 <span><?php echo $TPL_VAR["add_info"]?></span></h4>
...
<?php if($TPL_VAR["product_type"]== 99){?>
        <!--<h3 class="goods-set__title">세트옵션 선택</h3>-->
<?php }else{?>
        <!--<h3 class="goods-set__title">옵션 선택</h3>-->
<?php }?>
...
<?php }?>
            ...
            <div id="devSlideMinicartAddOption" class="hidden goods-option--add">
                <h3 class="goods-option__title">옵션상품</h3>
            </div>

            <div class="goods-cart__wrap">
                <ul id="devSlideMinicartSelected" class="goods-cart">
                    <li class="goods-cart__box devOptionBox devForbizTpl" devOptionKind="{[option_kind]}"
                        devOptid="{[option_id]}" devUnit="{[option_dcprice]}" devStock="{[option_stock]}">
...
<?php }elseif($TPL_VAR["status"]=='ready'){?>
                <button type="button" class="goods-btn__sold-out devOrderDirect" disabled>판매예정</button>
<?php }elseif($TPL_VAR["status"]=='end'){?>
                <button type="button" class="goods-btn__sold-out devOrderDirect" disabled>판매종료</button>
<?php }else{?>
                <button type="button" class="goods-btn__sold-out devOrderDirect" disabled>일시품절</button>
<?php }?>

                <ul class="goods-btn">
<?php if($TPL_VAR["status"]=='sale'){?>
                        <li class="col_l"><button type="button" class="goods-btn__store" id="storeGuide_ig" data-id="<?php echo $TPL_VAR["id"]?>" data-type="<?php echo $TPL_VAR["product_type"]?>">매장안내</button></li>                    
<?php }elseif($TPL_VAR["status"]=='ready'){?>
                        <button type="button" class="goods-btn__store" id="storeGuide_ig" data-id="<?php echo $TPL_VAR["id"]?>" data-type="<?php echo $TPL_VAR["product_type"]?>">매장안내</button>
<?php }elseif($TPL_VAR["status"]=='end'){?>
                        <button type="button" class="goods-btn__store" id="storeGuide_ig" data-id="<?php echo $TPL_VAR["id"]?>" data-type="<?php echo $TPL_VAR["product_type"]?>">매장안내</button>
<?php }else{?>
                        <button type="button" class="goods-btn__store" id="storeGuide_ig" data-id="<?php echo $TPL_VAR["id"]?>" data-type="<?php echo $TPL_VAR["product_type"]?>">매장안내</button>
...
<?php if($TPL_VAR["status"]=='sale'){?>
                    <li class="col_r"><button type="button" class="goods-btn__cart devAddCart_ig devAddCart__layerBtn">장바구니</button></li>
<?php }?>
...
<?php if($TPL_VAR["is_use_reserve"]){?>
                <dl class="goods-info__other__list">
                    <dt>적립금</dt>
                    <dd>예상적립금 <span class="goods-info__other__list--point"><em><?php echo $TPL_VAR["fbUnit"]["f"]?><?php echo g_price($TPL_VAR["save_reserve"])?></em><?php echo $TPL_VAR["fbUnit"]["b"]?></span><br>(적립금은 결제 시 상이할 수 있습니다.)</dd>
                </dl>
<?php }?>
                <dl class="goods-info__other__list">
                    <dt>배송정보</dt>
...
<?php if($TPL_VAR["langType"]=='korean'){?>
            <div class="goods-info__review">
                <span class="goods-info__review__title">상품후기</span>
                ...
                <button type="button" class="goods-info__review__btn" >후기 보러가기</button>
            </div>
<?php }else{?>
<?php }?>
...
<?php if($TPL_VAR["langType"]=='korean'){?>
    ...
    <!-- <section class="br__goods-view__photo">
        <div class="goods-photo">
            <h3 class="goods-photo__title">포토리뷰</h3>
            <p class="goods-photo__sub">고객님들의 솔직한 포토 리뷰를 확인해 보세요.</p>
...
<?php if($TPL_VAR["togeterProduct"]){?>
    <section class="br__goods-view__recommend">
        <div class="goods-recom">
            <h3 class="goods-recom__title">다른 고객님이 함께 구매한 상품</h3>
...
<?php if($TPL_VAR["similraProduct"]){?>
    <section class="br__goods-view__recommend">
        <div class="goods-recom">
            <h3 class="goods-recom__title">비슷한 상품</h3>
            <div class="goods-recom__wrap">
                <ul class="goods-recom__list">
...
<?php }}?>
                ...
                <div class="slide-layer">
                    <h4 class="slide-layer__title">전체보기</h4>
...
<?php if($TPL_VAR["langType"]=='korean'){?>
                <li class="goods-tabs__box">
                    <a href="#goods-review" class="goods-tabs__btn devDetailTabs devReviewDetailTabs" data-content="devTabReview">상품후기<br><em><?php echo $TPL_VAR["total_review_cnt"]?></em></a>
                    <!--<a href="#goods-review" class="goods-tabs__btn devDetailTabs devReviewDetailTabs" data-content="devTabReview">상품후기(<?php echo $TPL_VAR["allReviewTotal"]?>)</a>-->
                </li>
<?php }else{?>
<?php }?>

                <li class="goods-tabs__box">
                    <a href="#goods-detail" class="goods-tabs__btn goods-tabs__btn2">상세정보</a>
                </li>
                ...
                <li class="goods-tabs__box">
                    <a href="#goods-qna" class="goods-tabs__btn devDetailTabs" data-content="devTabInquiry">Q&amp;A <br><em><?php echo number_format($TPL_VAR["qnaTotal"])?></em></a>
                </li>
                <!-- <li class="goods-tabs__box">
                    <a href="#goods-notice" class="goods-tabs__btn">반품/환불</a>
                </li> -->
            </ul>
        </div>
        <section class="goods-tabs__cont goods-review">
            <a id="goods-review" class="br__hidden--anchor">상품후기<br><em><?php echo $TPL_VAR["total_review_cnt"]?></em></a>
...
<?php }?>
        ...
        <section class="goods-tabs__cont goods-detail">
            <a id="goods-detail" class="br__hidden--anchor">상품 상세정보 탭</a>


<?php if($TPL_VAR["productGiftInfo"]){?>
            <div class="goods-detail__acco">
                <button type="button" class="goods-detail__acco__btn">사은품 안내</button>
...
<?php if($TPL_V1["status"]!='soldout'){?>
                        ...
                        <div class="gift-cont__info">
                            ...
                            <p class="gift-cont__info__date">행사기간 : <?php echo $TPL_V1["sell_priod_sdate"]?> ~ <?php echo $TPL_V1["sell_priod_edate"]?></p>
                            <p class="gift-cont__info__price"><span><?php echo $TPL_V1["add_info"]?></span>원 상당</p>
                        </div>
<?php }?>
<?php }}?>
                        <div class="gift-cont__notice">
                            <p class="gift-cont__notice__desc">- 반품 및 환불 시 사은품을 동봉해주셔야 합니다. 미동봉 시 처리가 어려울 수 있으니 이점 유의해주시길 바랍니다.</p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php if($TPL_VAR["langType"]=='korean'){?>
        <section class="goods-tabs__cont goods-review ">
            ...
            <a id="goods-review_IG" class="br__hidden--anchor">상품 후기 탭</a>

            <!--<h4 class="goods-review__title">상품후기 <span>(<?php echo $TPL_VAR["total_review_cnt"]?>)</span></h4>
            <p class="goods-review__des">상품에 대한 다른 고객님들의 후기입니다.</p>-->

            <h4 class="goods-review__title">베스트 리뷰</h4>
...
<?php if($TPL_VAR["langType"]=='korean'){?>
            <div class="goods-review__best">
                ...
                <!-- <h5 class="goods-review__best__title">매달 베스트 리뷰 선정!</h5> -->
                <p class="goods-review__best__desc">매달 <strong>마지막 주 목요일</strong> 마다 베스트리뷰를 선정합니다.<br><?php if($TPL_VAR["isCosmetic"]){?> 배럴 코스메틱스 <?php }else{?> 전신 <?php }?> 착용컷과 함께 정성스러운 후기 내용이면 <br>확률이 올라갑니다.</p>
                <div class="goods-review__best__rank">
                    <ul class="rank-list2">
                        <li><span class="rank-list2-txt1">1등</span><span class="rank-list2-txt2"><?php echo $TPL_VAR["fbUnit"]["f"]?><strong>50,000</strong><?php echo $TPL_VAR["fbUnit"]["b"]?></span></li>
                        <li><span class="rank-list2-txt1">2등</span><span class="rank-list2-txt2"><?php echo $TPL_VAR["fbUnit"]["f"]?><strong>20,000</strong><?php echo $TPL_VAR["fbUnit"]["b"]?></span></li>
                        <li><span class="rank-list2-txt1">3등</span><span class="rank-list2-txt2"><?php echo $TPL_VAR["fbUnit"]["f"]?><strong>10,000</strong><?php echo $TPL_VAR["fbUnit"]["b"]?></span></li>
                    </ul>
                    <!-- <ul class="rank-list">
                        <li class="rank-list__box">
                            <span class="rank-list__rank">1등</span>
                            <span class="rank-list__prize"><?php echo $TPL_VAR["fbUnit"]["f"]?>50,000<?php echo $TPL_VAR["fbUnit"]["b"]?></span>
                        </li>
                        <li class="rank-list__box">
                            <span class="rank-list__rank">2등</span>
                            <span class="rank-list__prize"><?php echo $TPL_VAR["fbUnit"]["f"]?>20,000<?php echo $TPL_VAR["fbUnit"]["b"]?></span>
                        </li>
                        <li class="rank-list__box">
                            <span class="rank-list__rank">3등</span>
                ...
                <p class="goods-review__best__refer">※ 후기 적립금은 온라인구매만 해당됩니다.</p>
                ...
                <div class="goods-review__best__kind">
                    <dl class="best-kind">
                        <dt class="best-kind__title">일반후기</dt>
                        <dd class="best-kind__desc"><strong>글 50자 이상의 생생한 후기</strong>를 남겨주시면 <strong><?php if($TPL_VAR["isCosmetic"]){?>500원<?php }else{?>3,000원<?php }?></strong>이 적립 됩니다.</dd>
                    </dl>
                    <dl class="best-kind">
                        <dt class="best-kind__title">포토후기</dt>
                        <dd class="best-kind__desc"><strong>글 50자 이상의 생생한 후기와 착용컷</strong>을 남겨주시면 <strong><?php if($TPL_VAR["isCosmetic"]){?>1,000원<?php }else{?>5,000원<?php }?></strong>이 적립 됩니다.</dd>
                    </dl>
                </div>

<?php if($TPL_VAR["reviewBanner"]){?>
                <div  class="goods-review__event">
                    <img src="<?php echo $TPL_VAR["reviewBanner"]["imgSrc"]?>" alt="">
                </div>
<?php }?>

            </div>
            <!-- <div class="goods-review__notice">
                <h5 class="goods-review__notice__title">적립불가 조건</h5>
                <ul class="goods-review__notice__list">
                    <li class="goods-review__notice__desc"></li>
                    <li class="goods-review__notice__desc">· 두 가지 제품으로 같은 사진을 두번 올리는 경우 및 중복후기 (복사/붙여넣기)의 경우 적립금은 한번만 지급.</li>
                    <li class="goods-review__notice__desc">· 글 50자는 ‘공백 제외/ 특수문자 제외 / ㅋ,ㅎ,ㅠ,..등 자음 및 모음 ,한자는 제외 숫자의 경우 한 글자로 처리.</li>
                    <li class="goods-review__notice__desc">· 오프라인 매장 구매, 공식 홈페이지 구매제품이 아닌 경우.</li>
                    <li class="goods-review__notice__desc">· 배송완료일로 부터 30일이 지난제품일 경우.</li>
                    <li class="goods-review__notice__desc">· 비회원으로 구입후 후기 작성 시 적립금 미지급.<span>(회원혜택)</span></li>
                    <li class="goods-review__notice__desc">· 1만원 이하의 상품일 경우 미지급.</li>
<?php if(!$TPL_VAR["isCosmetic"]){?>
                    <li class="goods-review__notice__desc">· 배럴 아울렛 상품 구매 시 구매후기 작성 및 후기작성으로 인한 적립금 지급 불가.</li>
<?php }?>
...
<?php }else{?>
                ...
                <div class="top">
                    <div class="review-tab tab-js">
                        <a class="devReviewsDiv active" data-bbsdiv="">전체<em><?php echo g_price($TPL_VAR["allReviewTotal"])?></em></a>
                        <a class="devReviewsDiv" data-bbsdiv="2">일반후기<em><?php echo g_price($TPL_VAR["reviewTotal"])?></em></a>
                        <a class="devReviewsDiv" data-bbsdiv="1">포토후기<em><?php echo g_price($TPL_VAR["premiumReviewTotal"])?></em></a>
                    </div>
                    <div class="detail-info-sorting jq-radio">
                        <a class="devSort on" data-orderby="real_regdate" data-sort="desc">최근등록순</a>
                        <a class="devSort" data-orderby="avg" data-sort="asc">평점낮은순</a>
                        <a class="devSort" data-orderby="avg" data-sort="desc">평점높은순</a>
                    </div>
                </div>
                            ...
                            <li id="devReviewDetail">
                                ...
                                <div class="review-detail">
                                    <div class="wrap-score">
                                        <span>상품평가 <img src="<?php echo $TPL_VAR["templet_src"]?>/img/icon/m_star_s_{[valuation_goods]}.png">{[valuation_goods]}</span>
                                        <span>배송평가 <img src="<?php echo $TPL_VAR["templet_src"]?>/img/icon/m_star_s_{[valuation_delivery]}.png">{[valuation_delivery]}</span>
                                    </div>
...
<?php }?>
        <section class="goods-tabs__cont goods-qna">
            <a id="goods-qna" class="br__hidden--anchor">상품 문의 탭</a>
            ...
            <div class="goods-qna__write">
                <h4 class="goods-qna__write__title">상품 Q&A&nbsp;<span>(<?php echo $TPL_VAR["qnaTotal"]?>)</span></h4>
                <p class="goods-qna__write__desc">고객님들의 문의사항을 신속하고 친절하게<br />안내하겠습니다.</p>
                <a href="javascript:void(0);" class="goods-qna__write__btn" id="devQnaWrite" data-pid="<?php echo $TPL_VAR["pid"]?>">상품 Q&A 작성하기</a>
            </div>
            ...
            <ul class="goods-qna__list" id="devQnaContents">
                ...
                <li class="goods-qna__box {[#if isSameUser]}{[else]}goods-qna__box--secret{[/if]}" id="devQnaDetail">
                    <button class="qna-info">
                        <!-- [S] 내 글인 경우 -->
                        {[#if isSameUser]}
                        <span class="qna-info__my-qna">[내가 쓴 Q&A]</span>
                        {[/if]}
                        <!-- [E] 내 글인 경우 -->
                    ...
                    <div class="qna-detail" id="devQnaDetailContents">
                        <div class="qna-detail__question" id="devQnaQuestion">
                            ...
                            <div class="qna-detail__question__mod">
                                <button type="button" class="qna-detail__question__btn devDeleteQna" data-bbs_ix="{[bbs_ix]}" >삭제</button>
                                <a href="javascript:void(0);" class="qna-detail__question__btn devModifyQna" data-bbs_ix="{[bbs_ix]}" data-pid="<?php echo $TPL_VAR["pid"]?>">수정</a>
                            </div>
                            {[/if]}
                            {[/if]}
                            <!-- [E] 답변 받기 전, 내 글인 경우 -->
...
<?php if($TPL_VAR["langType"]=='korean'){?>
                <div class="goods-detail__acco">
                    <button type="button" class="goods-detail__acco__btn">상품정보 제공 고시</button>
...
<?php }?>
        ...
        <section class="goods-tabs__cont goods-notice">
            <a id="goods-notice" class="br__hidden--anchor">교환 반품 정보 탭</a>
            <ul class="goods-notice__list">
                <li class="goods-notice__box">
                    <button type="button" class="goods-notice__btn goods-notice__btn--shipping">배송 안내</button>
                </li>
                <li class="goods-notice__box">
                    <button type="button" class="goods-notice__btn goods-notice__btn--precautions">세탁·주의사항 안내</button>
                </li>
                <li class="goods-notice__box">
                    <button type="button" class="goods-notice__btn goods-notice__btn--cliam">반품/환불 안내</button>
                </li>
                <li class="goods-notice__box">
                    <button type="button" class="goods-notice__btn goods-notice__btn--repair">상품수선안내</button>
                </li>
            </ul>
        </section>
    </section>
...
<?php }?>
                     ...
                     <span class="minicart__banner__desc--point">[누적금액 70만원 이상 고객 항시 무료배송]</span>
                </p>
            </div>
            <section class="br__goods-view__information">
                <div class="goods-info">
...
<?php if($TPL_VAR["product_type"]== 99){?>
                    <h4 class="goods-info__set__title" style="font-weight:600;">세트옵션 선택</h4>
<?php }?>
...
<?php }?>
                ...
                <ul class="goods-cart" id="devMinicartSelected"><li class="goods-cart__box devForbizTpl devOptionBox" devPid="{[pid]}" devOptionKind="{[option_kind]}" devOptid="{[option_id]}" devUnit="{[option_dcprice]}" devStock="{[option_stock]}">
                        <p class="goods-cart__tit">{[option_prefix]}{[pname]}</p>
                        <p class="goods-cart__sub">{[add_info_text]}</p>
                        <p class="goods-cart__sub">{[option_div_text]}</p>
                        <div class="control">
            ...
            <div class="minicart__total">
                <span class="minicart__total__text">총 상품 금액</span>
                ...
                <!--<span class="minicart__total__count">(<span class="devMinicartPrdCnt">0</span>개)</span>-->
            </div>
        </div>
    </section>
    <!-- [E] 미니카트 -->
    ...
    <section class="br__goods-view__btn">
        <div class="goods-btn">
<?php if($TPL_VAR["langType"]=='korean'){?>
            <button type="button" class="goods-btn__store" id="storeGuide" data-id="<?php echo $TPL_VAR["id"]?>" data-type="<?php echo $TPL_VAR["product_type"]?>">매장안내</button>
<?php }?>
<?php if($TPL_VAR["viewMode"]=='preview'){?>
            <button type="button" class="goods-btn__sold-out devOrderDirect" disabled>미리보기 상품</button>
<?php }else{?>
<?php if($TPL_VAR["status"]=='sale'){?>
                <button type="button" class="goods-btn__cart devAddCart devAddCart__layerBtn">장바구니</button>
                <button type="button" class="goods-btn__buy devOrderDirect">구매하기</button>
<?php }elseif($TPL_VAR["status"]=='ready'){?>
                <button type="button" class="goods-btn__sold-out devOrderDirect" disabled>판매예정</button>
<?php }elseif($TPL_VAR["status"]=='end'){?>
                <button type="button" class="goods-btn__sold-out devOrderDirect" disabled>판매종료</button>
<?php }else{?>
                <button type="button" class="goods-btn__sold-out devOrderDirect" disabled style="height:4.5rem;">일시품절</button>
<?php }?>
<?php }?>
        </div>
    </section>
...
<?php }else{?>
                    <dt class="gform__common__top">상품수선안내</dt>
...
<?php $this->print_("productPrecautions",$TPL_SCP,1);?>
...
<button class="goods-view__recent-btn goods-view__recent-btn2 goods-view__recent-btn--imsi open-layer__recent-view " data-title="최근본상품">
