<?php /* Template_ 2.2.8 2024/03/04 06:25:53 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/content/style_detail/style_detail.htm 000006426 */ 
...
<!-- 컨텐츠 영역 S -->
			<section class="br__StyleCuration-detail">
													...
													<a href="/shop/goodsView/<?php echo $TPL_V2["id"]?>" class="goods-list__link">
														<div class="goods-list__thumb">
															...
															<label class="goods-list__wish">
																<input type="checkbox" class="goods-list__wish__btn" style="display: none" />
															</label>
															<!-- 체크 박스로 할 경우 E -->
														</div>
