<?php /* Template_ 2.2.8 2020/08/31 15:56:55 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/bbs_templet/teacher/bbs_read.htm 000003552 */ 
...
<?php if(empty($TPL_VAR["comment_loop"])){?>
    <div class="read__btn--wrap" style="text-align: center;">
        <a class="read__btn__list" href="javascript:void(0);" id="devDeleteInquiry">삭제</a>
        <a class="read__btn__list" style="color: #fff; background: #000;" href="/brand/teacherMember/write/<?php echo $TPL_VAR["bbs_ix"]?>">수정</a>
        <a class="read__btn__list" href="/brand/teacherMember">목록</a>
    </div>
<?php }?>
</section>