<?php /* Template_ 2.2.8 2023/05/30 10:29:58 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/popup/freebie_select/freebie_select.htm 000002609 */ 
...
<div class="freebie-select">
    ...
    <p class="freebie-select__count">선택 가능한 사은품 :
...
<?php }}?>
    ...
    <div class="freebie-select__btns">
        ...
        <button type="button" class="freebie-select__btns__cancel devNoChoice" data-src="<?php echo $TPL_VAR["layoutCommon"]["templetSrc"]?>" data-freegift_condition="<?php echo $TPL_V1["freegift_condition"]?>">사은품 선택 안함</button>
        <button type="button" class="freebie-select__btns__submit devSubmit" data-freegift_condition="<?php echo $TPL_V1["freegift_condition"]?>">사은품 선택</button>
    </div>
</div>
<?php }}?>
<?php }?>