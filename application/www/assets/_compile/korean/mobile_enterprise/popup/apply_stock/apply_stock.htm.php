<?php /* Template_ 2.2.8 2023/07/18 10:19:58 /home/barrel-qa/application/www.bak/assets/mobile_templet/mobile_enterprise/popup/apply_stock/apply_stock.htm 000006499 */ 
...
<div class="goods-alarm">
    <form id="devReStock" name="devReStock" action="/controller/product/productReStockMobile">
        ...
        <div class="goods-alarm__scroll">
            <h3 class="goods-alarm__title">입고 알림을 <br>신청해보세요!</h3>
            <p class="goods-alarm__desc">상품이 입고되는 즉시 등록하신 휴대폰 번호로 <br>알림 문자를 보내드립니다.</p>
...
<?php }?>
            ...
            <ul class="goods-alarm__notice">
                <li class="goods-alarm__notice__desc">· SMS 요청이 완료된 상품은 재입고알림 목록으로 저장됩니다.</li>
                <li class="goods-alarm__notice__desc">· SMS 요청상품의 가격, 옵션 구성 등의 상품정보가 변동될 수 있으므로, 재입고시 상품정보 확인 후 구매하시기 바랍니다.</li>
                <li class="goods-alarm__notice__desc">· 재입고 SMS알림은 요청일로부터 15일간 유효합니다.</li>
            </ul>
            <buttton class="goods-alarm__submit" id="devSumbitBtn">신청하기</buttton>
        </div>
    </form>
</div>
<script>
