<?php /* Template_ 2.2.8 2024/03/29 21:29:40 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/layout/layout_default.htm 000016885 */ ?>
<!DOCTYPE html>
...
<?php $this->print_("footerMenu",$TPL_SCP,1);?> <?php $this->print_("footerDesc",$TPL_SCP,1);?>

			</footer>

			<!-- modal -->
			<div class="popup-mask" id="modalMaskDefault"></div>
			<div class="popup-layout" id="modalDefault">
				<p class="popup-title">
			...
			<!-- slide_modal -->
			<div class="slide-popup-layout popup-layout__full">
				<div class="popup-layout__wrap">
					<div class="popup-title">
						<div class="title-md" id="devSlideModalTitle">주문 조회</div>
						<span class="close btn-close">닫기</span>
					</div>
					<div class="popup-content__wrap">
						<div class="popup-content" id="devSlideModalContent">
						</div>
					</div>
				</div>
			</div>
