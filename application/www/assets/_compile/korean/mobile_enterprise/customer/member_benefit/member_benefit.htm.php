<?php /* Template_ 2.2.8 2024/03/20 09:39:46 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/customer/member_benefit/member_benefit.htm 000009786 */ ?>
<!-- 컨텐츠 S -->
<section class="br__benefit">
	...
	<div class="br__benefit-wrap">
		<div class="page-title">
			<div class="title-md">회원혜택</div>
		</div>
		<section class="br__benefit-member">
			<div class="br__benefit-title">
		...
		<section class="br__benefit-level">
			<div class="br__benefit-title">
...
<?php if($TPL_VAR["layoutCommon"]["isLogin"]){?>
					<button class="btn-lg btn-dark-line">회원가입</button>
<?php }else{?>
					<a href="/member/joinInput" class="btn-lg nonmember"><button class="btn-lg btn-dark-line">회원가입</button></a>
<?php }?>
				</div>
