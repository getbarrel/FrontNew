<?php /* Template_ 2.2.8 2024/01/22 13:34:40 /home/barrel-qa/application/www.bak/assets/mobile_templet/mobile_enterprise/customer/cliam_guide/cliam_guide_content.htm 000021898 */ ?>
<div class="br__claim-wrap">
...
<!--
<section class="claim">
    <h3 class="claim__title">[ 교환/반품 ]</h3>
    <div class="claim__content">
        <ul class="claim__content__dotted">
			<li><span class="claim__content__dotted--point">수령 후 7일 이내 청약 철회(교환/반품) 신청이 가능합니다.</span><br>(단,  재화 등의 내용이 표시, 광고 내용과 다르거나 계약 내용과 다르게 이행된 때에는 당해 재화 등을 공급받은 날로부터 3개월 이내, 그 사실을 안 날 또는 알수 있었던 날부터 30일 이내에 청약철회가 가능합니다.)</li>
			<li class="claim__content__dotted--point">교환/반품 신청은 [마이페이지>주문내역조회] 또는 [1:1문의하기]로 문의 부탁드립니다.</li>
			<li class="claim__content__dotted--point">교환/반품 배송비 : 왕복 5,000원<br>(제주 및 도서산간 지역 추가 운임 발생)</li>
			<li><span class="claim__content__dotted--point">교환/반품 배송비 입금안내 :  기업은행 /  551-037000-01-010  / (주)배럴</span><br>(판매자 과실의 경우 청구되지 않습니다.)</li>
			<li class="claim__content__dotted--point">물류센터 주소 안내 : 경기도 이천시 호법면 중부대로798번길 103-40 [배럴 물류센터]</li>
			<li class="claim__content__dotted--point">택 제거 및 착용 등 상품 가치가 훼손된 경우 교환/반품 처리가 불가합니다.</li>
			<li class="claim__content__dotted--point">교환/반품은 상품 입고 이후 3~5일(영업일 기준) 이내에 상품 검수가 이루어지며, 판매자와 구매자간 반품 사유에 대한 분쟁이 없을 경우 실 진행 되고 있습니다.</li>
			<li class="claim__content__dotted--point">교환 신청하신 제품이 품절일 경우 환불로 진행될 수 있습니다.</li>
			<li class="claim__content__dotted--point">단순변심으로 인한 반품 시 사용하신 쿠폰은 다시 반환되지 않습니다.</li>
			<li class="claim__content__dotted--point">부분 반품 시 사용하신 적립금과 쿠폰은 다시 반환되지 않습니다.</li>
			<li class="claim__content__dotted--point">배송 기사님 방문 시 부재중이거나, 고객님의 정보오류로 인해 반송된 제품은 재 배송 시 착불로 발송됩니다.</li>
        </ul>
    </div>
</section>
<section class="claim">
    <h3 class="claim__title">[ 교환 및 반품이 불가능한 경우 ]</h3>
    <div class="claim__content">
        <ul class="claim__content__dotted">
			<li class="claim__content__dotted--point">온라인 주문  시 오프라인 매장에서 교환 / 반품 / 환불 처리 불가하오니  각 구매처로 문의 부탁드립니다.</li>
			<li class="claim__content__dotted--point">수령 후 7일 이내 이더라도 교환 및 반품 불가가 고지된 일부 상품은 접수가 불가합니다.</li>
			<li><span class="claim__content__dotted--point">택, 브랜드 박스 등 이 손상 되거나 착용 등 상품 가치가 훼손된 경우 교환/반품 처리가 불가합니다.</span><br>(예시 : 신축성 있는 제품 (탱크 탑, 브라 탑, 브라패드, 레깅스, 비키니, 비키니 팬츠, 이너 웨어) 은 시착 시  교환/반품 불가)</li>
        </ul>
    </div>
</section>
<section class="claim">
    <h3 class="claim__title">[ 교환 및 반품 시 박스 포장 예시 ]</h3>
    <div class="claim__content">
        <ul class="claim__content__dotted">
...
<section class="claim">
    <h3 class="claim__title">[ 교환 및 반품 신청 수 철회 ]</h3>
    <div class="claim__content">
        <ul class="claim__content__dotted">
			<li><span class="claim__content__dotted--point">교환/반품 접수 철회를 요청하실 경우, 고객센터로 연락 주시기 바랍니다.</span><br>(단, 이미 수거지시 및 수거가 진행 중인 경우에는  철회가 불가할 수 있습니다.)</li>
        </ul>
    </div>
</section>
<section class="claim">
    <h3 class="claim__title">[ 교환 및 반품 절차 ]</h3>
    <div class="claim__content">
        <ul class="claim__content__dotted">
			<li><span class="claim__content__dotted--point">수령 후 7일 이내 청약 철회(교환/반품) 신청이 가능합니다.</span><br>(단,  재화 등의 내용이 표시, 광고 내용과 다르거나 계약 내용과 다르게 이행된 때에는 당해 재화 등을 공급받은 날로부터 3개월 이내, 그 사실을 안 날 또는 알수 있었던 날부터 30일 이내에 청약철회가 가능합니다.)<br><br>
			[수거 방법]<br>
			① 지정 택배사의 택배기사가 방문하여 수거<br>
			&nbsp;&nbsp;-교환/반품 신청 후 3일 이내에 대한통운 택배 기사분이 수령지로 방문하여 수거를 진행 합니다.<br>
			②고객님께서 직접 발송 (타 택배사 이용하여 직접 반송)<br>
			&nbsp;&nbsp;-지정된 택배사가 아닌 타 택배회사를 이용하실 경우 택배비는 고객님께서 선 결제 후 발송 부탁 드립니다.<br>
			(직접 발송하시는 경우 주문서 확인을 위해 고객님 정보 혹은 주문번호 등이 기재된 메모를 동봉 후 보내주셔야 반품 처리가 지연되지 않습니다.)
			</li>
			<li class="claim__content__dotted--point">교환/반품 신청은 [마이페이지>주문내역조회] 또는 [1:1문의하기]로 문의 부탁드립니다.</li>
			<li><span class="claim__content__dotted--point">교환/반품 배송비 : 왕복 5,000원</span><br>(제주 및 도서산간 지역 추가 운임 발생)</li>
			<li><span class="claim__content__dotted--point">교환/반품 배송비 입금안내 :  기업은행 /  551-037000-01-010  / (주)배럴</span><br>(판매자 과실의 경우 청구되지 않습니다.)</li>
			<li class="claim__content__dotted--point">물류센터 주소 안내 : 경기도 이천시 호법면 중부대로798번길 103-40 [배럴 물류센터]</li>
			<li class="claim__content__dotted--point">택 제거 및 착용 등 상품 가치가 훼손된 경우 교환/반품 처리가 불가합니다.</li>
			<li class="claim__content__dotted--point">교환/반품은 상품 입고 이후 3~5일(영업일 기준) 이내에 상품 검수가 이루어지며, 판매자와 구매자간 반품 사유에 대한 분쟁이 없을 경우 실 진행 되고 있습니다.</li>
