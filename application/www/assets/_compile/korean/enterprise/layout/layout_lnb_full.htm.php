<?php /* Template_ 2.2.8 2024/03/19 09:21:49 /home/barrel-stage/application/www/assets/templet/enterprise/layout/layout_lnb_full.htm 000009294 */ ?>
<!DOCTYPE html>
...
<?php if($TPL_VAR["layoutCommon"]["bodyId"]=='shop_goodsView'){?>
<?php }else{?>
    <nav class="layout-lnb <?php if($TPL_VAR["layoutCommon"]["bodyId"]=='shop_search'){?> layout-lnb__search <?php }?>">
