<?php /* Template_ 2.2.8 2021/03/04 13:45:15 /home/barrel-stage/application/www/assets/templet/enterprise/layout/header/header_menu_bak.htm 000015272 */ ?>
				...
				<li class="header__sns__box">
					<span class="header__sns__link header__sns__link--instagram">
						...
						<ul class="header__sns__list header__sns__list--insta">
							<li class="header__sns__box">
								<a href="https://www.instagram.com/barrel.lifestyle/?hl=ko" class="header__sns__link header__sns__link--official" target="_blank">배럴 오피셜</a>
							</li>
							<li class="header__sns__box">
								<a href="https://www.instagram.com/barrel.swim" class="header__sns__link header__sns__link--swim" target="_blank">배럴 스윔</a>
							</li>
							<li class="header__sns__box">
								<a href="https://www.instagram.com/barrel.fit" class="header__sns__link header__sns__link--fit" target="_blank">배럴 핏</a>
							</li>
							<li class="header__sns__box">
							<a href="https://www.instagram.com/barrel.cosmetics" class="header__sns__link header__sns__link--cosmetics" target="_blank">배럴 코스메틱스</a>
							</li>
						</ul>
					</span>
				</li>
				<li class="header__sns__box">
					<a href="https://www.facebook.com/pages/Barrel/1416024818648425" class="header__sns__link header__sns__link--facebook" target="_blank">페이스북</a>
				</li>
<?php if($TPL_VAR["langType"]=='korean'){?>
				<li class="header__sns__box">
					<a href="https://pf.kakao.com/_VxfxjDd" class="header__sns__link header__sns__link--kakao" target="_blank">카카오플친</a>
				</li>
				<li class="header__sns__box">
					<a href="http://blog.naver.com/socal_kr" class="header__sns__link header__sns__link--blog" target="_blank">블로그</a>
				</li>
<?php }?>
				<li class="header__sns__box">
					<a href="https://www.youtube.com/c/getbarrel" class="header__sns__link header__sns__link--youtube" target="_blank">유튜브</a>
				</li>
			</ul>
		</div>
		<a href="/brand/visual">
			...
			<ul class="header__sns__list">
				<li class="header__sns__box">
							<span class="header__sns__link ">
								<a href="/event/eventDetail/47">스프린트 챔피언십</a>
							</span>
				</li>
				<li class="header__sns__box">
							<span class="header__sns__link ">
								<a href="/event/eventDetail/208" >SOS 캠페인</a>
							</span>
				</li>
				<li class="header__sns__box">
							<span class="header__sns__link ">
								<!--@TODO 오픈 이후 URL 확인 필요 -->
								<a href="/brand/cheering" target="_blank">치어링 유어 스웻</a>
							</span>
				</li>
			</ul>
		</div>
...
<?php if($TPL_VAR["layoutCommon"]["isLogin"]){?>
		<p class="header__name">
			<span><?php echo $TPL_VAR["layoutCommon"]["userInfo"]["name"]?></span><span class="eng-hidden">님</span>
		</p>
<?php }?>
		<nav class="header__topMenu__myMenu">
<?php if($TPL_VAR["layoutCommon"]["isLogin"]){?>
			<a class="log devLogout">로그아웃</a>
			<div class="mypage">
...
<?php }else{?>
			<a href="/member/login?url=<?php echo urlencode($_GET['url'])?>" class="log">로그인</a>
			<a href="/member/joinInput" class="join">회원가입</a>
			<div class="mypage">
				<a href="/mypage/" class="mypage__link">마이페이지</a>
				<ul class="mypage__detail-menu">
					<li><a href="/mypage/orderHistory">주문내역 조회</a></li>
...
<?php }?>
			<a href="/shop/cart" class="cart">장바구니<em id='cart_total_cnt' class='cart_total_cnt'><?php echo $TPL_VAR["layoutCommon"]["userInfo"]["cartCnt"]?></em></a>
...
<?php }}?>
				...
				<div class="fb__sns">
					<div class="fb__sns__inner">
						<h3 class="fb__sns__title">소셜미디어</h3>
						<div class="sns-btn">
		...
		<div class='header__search wrap-header-search'>
			...
			<fieldset class="search-area">
				...
				<div class="wrap-search-layer">
					<ul class=" search-tab">
						<a href="#tab1" class="active">인기검색어</a>
						<a href="#tab2">최근검색어</a>
					</ul>
...
<?php }?>
					...
					<div class="wrap-search-layer__info">
						...
						<a href="#" id="devRecentKeyWordDeleteAll">전체 삭제</a>
					</div>
				</div>
			</fieldset>
		</div>
...
<!--<a href="#" class="nav__all-btn" >전체메뉴</a>-->
<!--<a href="/event/eventList" class="font-en">이벤트</a>-->
<!--<a href="/event/promotion/" class="font-en">기획전</a>-->
<!--<a href="/best/best" class="font-en">베스트</a>-->