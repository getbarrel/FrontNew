<?php /* Template_ 2.2.8 2020/08/31 15:57:06 /home/barrel-stage/application/www/assets/templet/enterprise/bbs_templet/teacher/bbs_read.htm 000003689 */ 
...
<section class="fb__bbs__detail">
    ...
    <h2 class="fb__bbs__detail__title " style="margin-top: 80px;">티처멤버 모집</h2>
...
<?php }?>
            <!--<nav class="detail__nav">-->
                <!--<button class="btn-default btn-dark-line" onclick="location.href = '/brand/teacherMember'">목록</button>-->
            <!--</nav>-->
        </div>
    </section>
<?php if(empty($TPL_VAR["comment_loop"])){?>
    <div class="wrap-btn-area mat40 fb__teacher__btn">
        <button type="button" class="btn-lg btn-dark-line" id="devDeleteInquiry">삭제</button>
        <a href="/brand/teacherMember/write/<?php echo $TPL_VAR["bbs_ix"]?>" ><button type="button" class="btn-lg fb__btn-black">수정</button></a>
