<?php /* Template_ 2.2.8 2024/03/22 08:50:02 /home/barrel-stage/application/www/assets/templet/enterprise/content/focus_now4/focus_now4.htm 000005974 */ 
...
<?php if($TPL_displayContentGroupList_1){foreach($TPL_VAR["displayContentGroupList"] as $TPL_V1){?>
					<div class="fb-tab__contents detail-layout__section" id="specia<?php echo $TPL_V1["group_code"]?>">
						<div class="fb-FocusNow__banner">
							<?php echo $TPL_V1["group_text_pc"]?>

						</div>
						<section class="detail-goods__wrap" style="padding-top:80px;">
