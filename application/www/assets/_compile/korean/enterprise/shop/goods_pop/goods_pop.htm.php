<?php /* Template_ 2.2.8 2023/07/18 10:20:06 /home/barrel-qa/application/www.bak/assets/templet/enterprise/shop/goods_pop/goods_pop.htm 000011521 */ 
...
.modal_wrap {width:600px;height:800px;background:#fff;box-sizing:border-box;z-index: 1002;position: relative;border-radius: 20px;}
.modal_head {position: absolute;top:0;left:0;width:100%;padding:20px 20px 0;border-bottom: 1px solid #ececec;z-index: 1;background: #fff;box-sizing: border-box; border-radius: 20px 20px 0 0;}
...
.size_guide_tab a {display: flex;margin-bottom:25px;font-size:16px;color:#8D8D8D;line-height:24px;align-items: center;}
...
.size_guide_img {text-align:center;max-width: 89%;display: inline-block;}
</style>
<div>
	<div class="modal_wrap">
		...
		<div class="modal_head">
			<!-- <div class="modal_tt_box">
				...
				<button type="button" class="modal_closed"><img src="/assets/templet/enterprise/img/btn/icon_closed.svg" alt="닫기" onclick="widown.close()"/></button>
			</div> -->
