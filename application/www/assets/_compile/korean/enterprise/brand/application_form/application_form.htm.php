<?php /* Template_ 2.2.8 2024/03/13 10:44:06 /home/barrel-stage/application/www/assets/templet/enterprise/brand/application_form/application_form.htm 000004903 */ ?>
<section class="br__apply">
    ...
    <div class="apply__btn">
        <a href="javascript:void(0);" id="goIndivisual" class="apply__btn--personal">개인 신청하러 가기</a>
        <a href="javascript:void(0);" id="goGroup" class="apply__btn--group">단체 신청하러 가기</a>
    ...
    <section class="inquiry-info">
        ...
        <p class="inquiry-info__desc">
            내가 신청한 신청서를 조회할 수 있습니다. 잘못 기입한 사항이 있으면<br>수정할 수 있으니 수정 가능기간(03.18 ~ 03.31) 을 확인 후 수정 바랍니다.
        </p>
