<?php /* Template_ 2.2.8 2024/03/13 16:49:39 /home/barrel-stage/application/www/assets/templet/enterprise/brand/application_form_group/application_form_group.htm 000045075 */ 
    ...
    <div class="fb__application-form fb__application-form--team">
        <div class="fb__application-form__head">
            <h2 class="fb__application-form__title">
                <?php echo $TPL_VAR["year"]?> 배럴 스프린트 챔피언십<br>
                온라인 참가 신청서<br>
                <strong>[단체]</strong>
            </h2>
            <p class="fb__application-form__desc">본 신청서는 단체 참가 신청서입니다. 필수 기입사항을 정확하게 기입해 주시기 바랍니다.</p>
        </div>
                        ...
                        <!--li class="inputs">
                            ...
                            <div class="inputs__content">
                                <div class="form-info-wrap info__address">
                                    <input type="text" class="w160" name="zip" id="devZip" class="inputs__content--zip" value="<?php echo $TPL_VAR["postnum"]?>" readonly title="우편번호 검색">
                                    <button type="button" class="btn-dark inputs__content--zip-search" id="devZipPopupButton">우편번호 검색</button>
                                    <input type="text" class=" info__address__input w362" name="addr1" id="devAddress1" value="<?php echo $TPL_VAR["address1"]?>" readonly>
                                    <input type="text" class="info__address__input w362" id="devAddress2" name="addr2" title="상세주소" value="<?php echo $TPL_VAR["address2"]?>">
                                </div>
                            </div>
                        </li-->
                        <li class="inputs">
                            ...
                            <div class="inputs__content info__pic">
                                <div class="form-info-wrap file-box">
                                    <input type="text" id="devMasterFileUrl" class="info__pic__input w362" name="group_master_image_url" title="사진첨부" value="<?php echo $TPL_VAR["group_master_image_url"]?>" >
                                    <input type="hidden" class="find-file__name" id="devMasterImageUrlPath" name="group_master_image_url_path" title="사진첨부" value="<?php echo $TPL_VAR["group_master_image_url_path"]?>">
...
<?php }?>
                ...
                <section class="input-form form-box">
                    <div class="form-box__head">
                        <h3 class="input-form__title-box__text form-box__title">대회 참가 정보</h3>
                        <span class="input-form__title-box__guide form-box__guide"><em class="star">*</em>표시된 항목은 필수 입력사항 입니다.</span>
                    </div>

                    <ul class="input-form__content-box">
                        <li class="inputs">
                            <span class="inputs__title">단체전 참가여부<br>(중복선택 가능)</span>
...
<?php if($TPL_attend_1){foreach($TPL_VAR["attend"] as $TPL_V1){?>
                                <label for="part<?php echo $TPL_V1["co_ix"]?>">
                                    ...
                                    <span class="txt" style="margin-left:0px;"><?php echo $TPL_V1["option_value"]?></span>
                                </label>
<?php }}?>
                        ...
                        <li class="inputs">
                            <span class="inputs__title">선수 인원수</span>
                            <div class="inputs__content team-number">
                                <input type="number" name="memberCnt" id="devMemberCnt" class="w110 input__user-number team-number__input" data-max="25" value="<?php echo $TPL_VAR["member_cnt"]?>" <?php if($TPL_VAR["type"]=='M'){?> readonly<?php }?>><!-- data-max : 최대 인원수 지정 -->
                                <span class="num-txt">명</span>
                                <p class="inputs__desc">
                                    · 인원수를 입력하시면 명단을 입력하실 수 있습니다.<br>
                                    <span class="inputs__desc--blue">
                                    · 1팀 당 구성 인원은 최대 25명입니다. (S그룹 참가자 포함)<br>
                            ...
                            <div id="member<?php echo $TPL_V1["cm_ix"]?>" class="entry-form__sheet">
                                ...
                                <ul class="inner">
                                    ...
                                    <li class="inputs ml40">
                                        <span class="inputs__title"><label>성별</label> <em class="star">*</em></span>
                                        <div class="inputs__content inputs__content--sex">
                                            <label class="inputs__label"><input type="radio" title="성별" name="sex[<?php echo $TPL_I1?>]" value="M" <?php if($TPL_V1["sex"]=='M'||$TPL_V1["sex"]==''){?>checked<?php }?>><span style="vertical-align: middle">남성</span></label>
                                            <label class="inputs__label"><input type="radio" title="성별" name="sex[<?php echo $TPL_I1?>]" value="F" <?php if($TPL_V1["sex"]=='F'){?>checked<?php }?>><span style="vertical-align: middle">여성</span></label>
                                        </div>
                                    </li>
                                    <li class="inputs ml40">
...
<?php }}?>
                                    ...
                                    <li class="inputs mt30 ml170">
                                        ...
                                        <div class="inputs__content info__pic">
                                            <div class="form-info-wrap file-box">
                                                <input type="text" class="info__pic__input w362 find-file__name devFileUrl" name="image_url[]" title="사진첨부" value="<?php echo $TPL_V1["image_url"]?>" readonly>
                                                <input type="hidden" class="find-file__name devImageUrlPath devRequire" name="image_url_path[]" title="사진첨부" value="<?php echo $TPL_V1["image_url_path"]?>">
                                                <label class="detail-box__list-file__choose file__label">파일찾기</label>
...
<?php }?>
                    ...
                    <ul class="input-form__content-box input-form__content-box2">
                        <li class="inputs">
                            <span class="inputs__title">입금계좌</span>
                            <div class="inputs__content">
                                <p class="inputs__content__text" >신한  <span class="inputs__desc--blue"> 140-010-165862  </span>    예금주 : (주)배럴</p>
                            </div>
                        </li>
                        <li class="inputs">
                            <span class="inputs__title">참가비</span>
                        ...
                        <li class="inputs">
                            <span class="inputs__title">입금자명 <em class="star">*</em></span>
...
<?php if($TPL_VAR["type"]!='M'){?>
                        <li class="inputs inputs__password">
                            <span class="inputs__title"><strong>신청서 비밀번호</strong> <em class="star">*</em></span>
                            <div class="inputs__content">
                ...
                <section class="input-form agree-area">
                    <div class="form-box__head">
                        <div class="input-form__title-box agree-area__title">
                            <label class="input-form__title-box__text"><input type="checkbox" class="checkbox-margin" id="all_terms_check" <?php if($TPL_VAR["all_check"]=='Y'){?> checked <?php }?>style="vertical-align: bottom;">전체 동의</label>
                        </div>
                    </div>

                    <ul class="input-form__content-box">
                        <li class="inputs inputs__agree agree-content">
                            <label><input type="checkbox" id="devPolicyUse" name="policyUse" data-title="이용약관" title="이용약관" <?php if($TPL_VAR["use_yn"]=='Y'){?> checked <?php }?> style="vertical-align: text-top;">이용 약관 (필수)</label>
                            <a href="#" class="inputs__content inputs__content--use view-all">전체보기</a>
                        </li>
                        <li class="inputs inputs__agree agree-content">
                            <label><input type="checkbox" id="devPolicyCollection" name="policyCollection"  title="개인정보 수집 및 이용" <?php if($TPL_VAR["collection_yn"]=='Y'){?> checked <?php }?> style="vertical-align: text-top;">개인정보 수집 및 이용 (필수)</label>
                            <a href="#" class="inputs__content inputs__content--private view-all">전체보기</a>
                        </li>
                        <!--<li class="inputs inputs__agree agree-content">-->
                            <!--<label><input type="checkbox" name="email" value="1" <?php if($TPL_VAR["email_yn"]=='Y'){?> checked <?php }?>  style="vertical-align: text-top;">이메일 수신 동의 (선택)</label>-->
                        <!--</li>-->
                        <!--<li class="inputs inputs__agree agree-content">-->
                            <!--<label><input type="checkbox" name="sms" value="1" <?php if($TPL_VAR["sms_yn"]=='Y'){?> checked <?php }?> style="vertical-align: text-top;">SMS 수신 동의 (선택)</label>-->
                        <!--</li>-->
                    </ul>
                </section>
				<div class="profile__footer" style="border-top:0px">
					<div class="profile__footer-btn">
						<button type="button" class="btn-lg btn-white-line group__btn--reset" id="devCancelButton">초기화</button>
<?php if($TPL_VAR["chkButton"]=='T'){?>
                        <button type="button" class="btn-lg btn-dark btn-point" id="devBasicSubmitButton">신청</button>
<?php }else{?>
                        <button type="button" class="btn-lg btn-dark btn-point" onclick="noSubmit('<?php echo $TPL_VAR["year"]?>','<?php echo $TPL_VAR["sdate"]?>');">신청</button>
<?php }?>
					</div><br>
				</div>
                <!-- <div class="wrap-btn-area member fb__join-member__btn-are fb__application-form__btn">
                    <button type="button" class="btn-lg btn-dark group__btn--reset" id="devCancelButton">초기화</button>
                    <button class="btn-lg btn-point" id="devBasicSubmitButton">신청</button>
                </div> -->
            </div>
        </form>
    </div>
        ...
        <div class="entry-form__sheet">
            <ul class="inner">
                <li class="inputs">
                    <span class="inputs__title">이름(실명) <em class="star">*</em></span>
                    <div class="inputs__content">
                        <input type="text" name="name[]" class="input__user-name w110 devRequire" title="이름(실명)">
                    </div>
                </li>
                <li class="inputs ml40">
                    <span class="inputs__title">
                ...
                <li class="inputs ml40">
                    <span class="inputs__title"><label>성별</label> <em class="star">*</em></span>
                    <div class="inputs__content inputs__content--sex">
                        <label class="inputs__label"><input type="radio" title="성별" name="sex[#num#]" value="M" checked><span style="vertical-align: middle">남성</span></label>
                        <label class="inputs__label"><input type="radio" title="성별" name="sex[#num#]" value="F"><span style="vertical-align: middle">여성</span></label>
                    </div>
                </li>
...
<?php }}?>
                ...
                <li class="inputs mt30 ml170">
                    ...
                    <div class="inputs__content info__pic">
                        <div class="form-info-wrap file-box">
                            <input type="text" class="info__pic__input w362 find-file__name devFileUrl devRequire" name="image_url[]" title="사진첨부" readonly>
                            <input type="hidden" class="find-file__name devImageUrlPath devRequire" name="image_url_path[]" title="사진첨부" value="">
                            <label class="detail-box__list-file__choose file__label">파일찾기</label>
                            <input class="btn-dark file__upload devFile" name="image_file[]" type="file"  title="파일찾기" data-url="/controller/event/tmpFileUpload">
                        </div>
                        <p class="inputs__desc">
