<?php /* Template_ 2.2.8 2024/03/13 16:01:34 /home/barrel-stage/application/www/assets/templet/enterprise/brand/application_form_Indivisual/application_form_Indivisual.htm 000023605 */ 
...
<section class="fb__content">
    <div class="fb__application-form fb__application-form--indivisual">
        <div class="fb__application-form__head">
            ...
            <p class="fb__application-form__desc">본 신청서는 개인 참가 신청서입니다. 필수 기입사항을 정확하게 기입해 주시기 바랍니다.</p>
        </div>
            ...
            <div class="fb__join-input__form fb__application-form__content">
                <section class="input-form form-box">
                    ...
                    <ul class="input-form__content-box">
                        ...
                        <li class="inputs">
                            <span class="inputs__title"><label for="">성별</label></span>
                            <div class="inputs__content inputs__content--sex">
                                <label class="inputs__label"><input type="radio" title="성별" name="sex" value="M" <?php if($TPL_VAR["sex"]=='M'||$TPL_VAR["sex"]==''){?>checked<?php }?>><span style="vertical-align: middle">남성</span></label>
                                <label class="inputs__label"><input type="radio" title="성별" name="sex" value="F" <?php if($TPL_VAR["sex"]=='F'){?>checked<?php }?>><span style="vertical-align: middle">여성</span></label>
                            </div>
                        </li>
                        <li class="inputs">
                        ...
                        <!--li class="inputs">
                            ...
                            <div class="inputs__content">
                                <div class="form-info-wrap info__address">
                                    <input type="text" class="w160" name="zip" id="devZip" class="inputs__content--zip" readonly title="우편번호 검색" value="<?php echo $TPL_VAR["postnum"]?>">
                        ...
                        <li class="inputs">
                            ...
                            <div class="inputs__content info__pic">
                                <div class="form-info-wrap file-box">
                                    <input type="text" class="info__pic__input w362 find-file__name" id="devImageUrl"  name="image_url" title="사진첨부" value="<?php echo $TPL_VAR["image_url"]?>" >
...
<?php }?>
                ...
                <section class="input-form form-box">
                    ...
                    <ul class="input-form__content-box">
                        <li class="inputs">
                            <span class="inputs__title"><label for="">소속명</label><em class="star">*</em></span>
                            <div class="inputs__content part-name">
                                ...
                                <p class="inputs__desc">
                                    <span class="inputs__desc--blue">
                                    · 소속이 없을 경우, ‘개인’ 이라고 기입하시기 바랍니다.<br>
                                    </span>
                                    · 특수기호(!, @, #, $, %, ^, &, (), * 등)는 사용이 불가합니다.
                                </p>
                            </div>
                        ...
                        <li class="inputs">
                            <span class="inputs__title">참가 그룹 <em class="star">*</em></span>
...
<?php }}?>
                                ...
                                <p class="inputs__desc" >
                                    ...
                                    · 참가자 기본 정보에서 기입하신 생년월일과 맞지 않는 그룹입니다.
                                    </span>
                                </p>
                            </div>
                        </li>
                        <li class="inputs">
                            <div>
                                <span class="inputs__title">참가종목1 <em class="star">*</em></span>
                                <div class="inputs__content">
...
<?php }}?>
                            ...
                            <div style="margin-top: -20px;">
                                <span class="inputs__title">참가종목2</span>
                                <div class="inputs__content">
...
<?php }}?>
                        ...
                        <li class="inputs">
                            ...
                            <div class="inputs__content part-cost">
                                <p class="inputs__content__text inputs__desc--blue">40,000원</p>
                            </div>
                        </li>
                        <li class="inputs deposit__info__name">
                            ...
                            <div class="inputs__content depositor deposit__info__checkbox">
                                ...
                                <label class="w200">
                                    ...
                                    <span class="txt">선수명과 동일합니다.</span>
                                </label>
                ...
                <section class="input-form agree-area">
                    <div class="form-box__head">
                        <div class="input-form__title-box agree-area__title">
                            <label for="all_terms_check" class="input-form__title-box__text"><input type="checkbox" class="checkbox-margin" id="all_terms_check" <?php if($TPL_VAR["all_check"]=='Y'){?> checked <?php }?> style="vertical-align: bottom;">전체 동의</label>
                        </div>
                    </div>

                    <ul class="input-form__content-box">
                        <li class="inputs inputs__agree agree-content">
                            <label><input type="checkbox" id="devPolicyUse" name="policyUse" data-title="대회 이용약관" id="devPolicyUse" title="대회 이용약관" <?php if($TPL_VAR["use_yn"]=='Y'){?> checked <?php }?> style="vertical-align: text-top;">대회 이용 약관 (필수)</label>
...
<?php }?>
                ...
                <!-- <div class="wrap-btn-area member fb__join-member__btn-are fb__application-form__btn">
                    ...
                    <button type="button" class="btn-lg btn-point" id="devBasicSubmitButton">신청</button>
                </div> -->
            </div>
        </form>
    </div>
