<?php /* Template_ 2.2.8 2020/08/31 15:57:16 /home/barrel-stage/application/www/assets/templet/enterprise/mypage/addressbook_select/addressbook_no_member.htm 000005177 */ ?>
...
<div class="popup-content">
    ...
    <div class="popup-btn-area">
        <button class="btn-default btn-dark-line" id="devAddressBookPopColseBtn">취소</button>
        <button class="btn-default btn-point" id="devAddressBookPopSaveBtn" data-oid="<?php echo $TPL_VAR["oid"]?>">저장</button>
    </div>
</div>