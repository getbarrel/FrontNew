<?php /* Template_ 2.2.8 2024/03/22 02:51:44 /data/barrel_data/_message/ms_email_order_sucess_vbank_new.htm 000025936 */ 
...
<p style="margin: 0; padding: 0"><span style="line-height: 24px; font-size: 16px; font-weight: bold; color: #000; font-family: sans-serif">주문이 정상적으로 접수 되었습니다.</span></p>
...
<div style="margin: 0; padding: 40px 0 0">
<p style="margin: 0; padding: 0 0 16px"><span style="line-height: 18px; font-size: 12px; font-weight: normal; color: #000; font-family: sans-serif"><?php echo $TPL_VAR["bank_input_date"]?>까지 결제 예정금액 <?php echo g_price($TPL_VAR["payment_price"])?>원을 입금해 주시기 바랍니다.</span></p>

<p style="margin: 0; padding: 0"><span style="line-height: 18px; font-size: 12px; font-weight: normal; color: #000; font-family: sans-serif">가상 계좌[에스크로] 주문 시 부분 취소가 불가하여 전체 취소만 가능합니다.</span></p>

<p style="margin: 0; padding: 0"><span style="line-height: 18px; font-size: 12px; font-weight: normal; color: #000; font-family: sans-serif">입금 전 구매하실 제품을 다시 한번 확인해 주시기 바랍니다.</span></p>
</div>

<div style="margin: 40px 0 0; padding: 22px 20px; border: 1px solid #ededed">
<table style="width: 100%; border-collapse: collapse; border-spacing: 0; padding: 0; margin: 0">
	<tbody>
		<tr>
			<td style="width: 70px"><span style="line-height: 18px; font-size: 12px; font-weight: bold; color: #000; font-family: sans-serif">입금 정보</span></td>
			<td><span style="line-height: 18px; font-size: 12px; font-weight: normal; color: #000; font-family: sans-serif"><?php echo $TPL_VAR["bank_name"]?> / 계좌번호 : <?php echo $TPL_VAR["bank_account_num"]?> / 예금주 : <?php echo $TPL_VAR["bank_input_name"]?></span></td>
		</tr>
		<tr>
			<td style="padding: 7px 0 0 0; width: 70px"><span style="line-height: 18px; font-size: 12px; font-weight: bold; color: #ff4e00; font-family: sans-serif">입금 기한</span></td>
			<td style="padding: 7px 0 0 0"><span style="line-height: 18px; font-size: 12px; font-weight: normal; color: #ff4e00; font-family: sans-serif"><?php echo $TPL_VAR["bank_input_date"]?>까지</span></td>
		</tr>
	</tbody>
</table>
</div>
...
<div style="padding: 20px 0; border-bottom: 1px solid #ededed">
<table style="width: 100%; border-collapse: collapse; border-spacing: 0; padding: 0; margin: 0">
	<tbody>
		<tr>
			...
			<td style="padding: 0"><?php if(is_array($TPL_R1=$TPL_VAR["deliveryInfo"]["msg"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?><?php if($TPL_V1["msg"]){?><span style="line-height: 18px; font-size: 12px; font-weight: normal; color: #000; font-family: sans-serif"><?php echo $TPL_V1["msg"]?></span> <?php }?> <?php }}?></td>
		</tr>
	</tbody>
</table>
</div>
...
<div style="margin: 40px 0; padding: 22px 20px; border: 1px solid #ededed">
<table style="width: 100%; border-collapse: collapse; border-spacing: 0; padding: 0; margin: 0">
	<tbody>
		<tr>
			<td style="width: 70px"><span style="line-height: 18px; font-size: 12px; font-weight: bold; color: #000; font-family: sans-serif">입금 정보</span></td>
