<?php /* Template_ 2.2.8 2022/09/23 06:04:49 /data/barrel_data/_message/ms_email_order_sucess.htm 000012409 */ 
	...
	<tbody>
		<tr>
			...
			<table align="center" border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse;" width="660">
				<thead>
					<tr>
						<td style="line-height: 0;padding-top: 8px;font-size: 0px;border-bottom-color: #000;border-bottom-width: 3px;border-bottom-style: solid;"><img alt="shop logo" src="/data/barrel_data/images/upfile//0001-0a29d0b5-6258ff4d-a9e6-c932ba14.png" style="margin-top: 8px; margin-bottom: 27px;" /></td>
					</tr>
				</thead>
				<tbody><!--contents-->
					<tr style="text-align: center;">
						<td style="color: #000;padding-top: 44px;font-size: 34px;">주문 및 결제가 정상적으로 완료되었습니다.</td>
					</tr>
					<tr style="text-align: center;">
						...
						만족할 수 있는 쇼핑이 되도록 최선을 다하겠습니다.</td>
					</tr>
					<tr>
						...
						<table cellpadding="0" cellspacing="0" style="text-align: center; padding-top: 30px; font-size: 12px; border-collapse: collapse;" width="100%">
							...
							<tbody><?php if(is_array($TPL_R2=$TPL_V1)&&!empty($TPL_R2)){foreach($TPL_R2 as $TPL_V2){?>
								<tr style="border: 1px solid rgb(204, 204, 204); border-image: none;">
									...
									<td width="10%"><?php echo g_price($TPL_V2["calc_dcprice"]* - 1)?>원</td>
...
<?php }}?></td>
						...
						<table cellpadding="0" cellspacing="0" style="border-collapse: collapse;" width="100%">
							<thead>
								<tr style="background: rgb(238, 238, 238); border: 1px solid rgb(204, 204, 204); border-image: none; height: 30px; text-align: center; font-size: 12px;">
									...
									<td style="width: 3%; line-height: 0; font-size: 0px;">&nbsp;</td>
									<td style="font-size: 16px; font-weight: bold;" width="24%">총 결제 금액</td>
								</tr>
							</thead>
							<tbody>
						...
						<table cellpadding="0" cellspacing="0" style="font-size: 12px; border-top-color: rgb(204, 204, 204); border-top-width: 1px; border-top-style: solid; border-collapse: collapse;" width="100%">
							<tbody>
								...
								<tr style="height: 40px; border-bottom-color: rgb(204, 204, 204); border-bottom-width: 1px; border-bottom-style: solid;">
									...
									<td width="80%"><?php echo $TPL_VAR["memo"]?> <?php echo $TPL_VAR["method_text"]?></td>
								</tr>
								<tr style="height: 40px; border-bottom-color: rgb(204, 204, 204); border-bottom-width: 1px; border-bottom-style: solid;">
					...
					<tr><!--delivery_info-->
						...
						<table cellpadding="0" cellspacing="0" style="font-size: 12px; border-top-color: rgb(204, 204, 204); border-top-width: 1px; border-top-style: solid; border-collapse: collapse;" width="100%">
							<tbody>
								...
								<tr style="height: 40px; border-bottom-color: rgb(204, 204, 204); border-bottom-width: 1px; border-bottom-style: solid;">
									<td style="padding: 0px 20px;" width="20%">전화번호</td>
									<td width="80%"><?php echo $TPL_VAR["deliveryInfo"]["rtel"]?></td>
								</tr>
							</tbody>
						</table>
						</td>
					...
					<tr><!--delivery_request-->
						...
						<table cellpadding="0" cellspacing="0" style="font-size: 12px; border-top-color: rgb(204, 204, 204); border-top-width: 1px; border-top-style: solid; border-collapse: collapse;" width="100%">
							<tbody><?php if($TPL_VAR["deliveryInfo"]["msg"]){?><?php if(is_array($TPL_R1=$TPL_VAR["deliveryInfo"]["msg"])&&!empty($TPL_R1)){foreach($TPL_R1 as $TPL_V1){?>
