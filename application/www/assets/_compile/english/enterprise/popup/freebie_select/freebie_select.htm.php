<?php /* Template_ 2.2.8 2020/08/31 15:57:17 /home/barrel-stage/application/www/assets/templet/enterprise/popup/freebie_select/freebie_select.htm 000002567 */ 
...
<?php }}?>
    ...
    <div class="freebie-select__bottom">
        <p class="freebie-select__desc">Selectable free gift(s) :
        ...
        <button type="button" class="freebie-select__submit noChoice devNoChoice" data-src="<?php echo $TPL_VAR["layoutCommon"]["templetSrc"]?>" data-freegift_condition="<?php echo $TPL_V1["freegift_condition"]?>">No select Free Gift</button>
        <button type="button" class="freebie-select__submit devSubmit" data-freegift_condition="<?php echo $TPL_V1["freegift_condition"]?>">Free Gift Select</button>
    </div>
</div>
<?php }}?>
<?php }?>