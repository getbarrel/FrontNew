<?php /* Template_ 2.2.8 2021/07/09 15:34:26 /home/barrel-stage/application/www/assets/templet/enterprise/fat/default.htm 000024981 */ ?>
<div id="fb__fat__wrapper" class="fb__fat">
    <div class="fat">
        <div class="fat__content">
            <header class="fat__header">
                <h2 class="fat__title">
                    Statistical analysis by product
                </h2>
            ...
            <div class="fat__goods">
                ...
                <h3 id="fat__content__goods__title" class="fat__goods__title">
                    <!-- Woman Neoprene Hoodie zip-up jacket -->
                </h3>
            ...
            <div id="fat_order_by_option" class="fat__filter">
                <div class="filter">
					...
					<nav id="fat_order_by_option_date_btn_group" class="filter__btn">
						...
						<label for="fat_order_by_option_date_today" class="rectangle-radio-label">Today</label>
						...
						<label for="fat_order_by_option_date_yesterday" class="rectangle-radio-label">Yesterday</label>

						<input id="fat_order_by_option_date_week" class="rectangle-radio-input" type="radio" name="fat_order_by_option_date" value="week"/>
						<label for="fat_order_by_option_date_week" class="rectangle-radio-label">1 Week</label>
						...
						<label for="fat_order_by_option_date_halfmonth" class="rectangle-radio-label">15 days</label>

						<input id="fat_order_by_option_date_month" class="rectangle-radio-input" type="radio" name="fat_order_by_option_date" value="month"/>
						<label for="fat_order_by_option_date_month" class="rectangle-radio-label">1 month</label>
                    </nav>
                </div>
                <div id="fat__tab__filters__order__pattern__group" class="fat__fn__filter">
					...
					<label for="fat_tab_filters_order_pattern_age" class="ellipse-radio-label">by Gender & Age</label>
					...
					<label for="fat_tab_filters_order_pattern_week" class="ellipse-radio-label">day</label>
					...
					<label for="fat_tab_filters_order_pattern_time" class="ellipse-radio-label">by time zone</label>
					...
					<label for="fat_tab_filters_order_pattern_together" class="ellipse-radio-label">(english)결제수단별</label>
                </div>
            </div>
            ...
            <div class="fat__excel">
				<div class="filter">
					<nav class="filter__btn">
						...
						<label for="fat__excel__date__today" class="rectangle-radio-label">Today</label>
						...
						<label for="fat__excel__date__yesterday" class="rectangle-radio-label">Yesterday</label>
						<input id="fat__excel__date__week" class="rectangle-radio-input" type="radio" name="fat__excel__filter__date" value="week"/>
						<label for="fat__excel__date__week" class="rectangle-radio-label">1 Week</label>
						...
						<label for="fat__excel__date__halfmonth" class="rectangle-radio-label">15 days</label>
						<input id="fat__excel__date__month" class="rectangle-radio-input" type="radio" name="fat__excel__filter__date" value="month"/>
						<label for="fat__excel__date__month" class="rectangle-radio-label">1 month</label>
					</nav>
				</div>
                <div class="filter__calendar">
                    <div class="filter__calendar__input">
        ...
        <div class="fat__content">
            ...
            <div class="syn">
                <nav class="syn__nav">
					...
					<label for="syn_nav_today" class="bottom__line__radio__label syn__nav__label">(english)오늘주문 분석</label>
					<input id="syn_nav_order_pattern" class="bottom__line__radio__input" type="radio" name="syn_nav" value="orderPattern"/>
					<label for="syn_nav_order_pattern" class="bottom__line__radio__label syn__nav__label">Analysis for purchase pattern</label>
					<input id="syn_nav_order_option" class="bottom__line__radio__input" type="radio" name="syn_nav" value="orderOption"/>
					<label for="syn_nav_order_option" class="bottom__line__radio__label syn__nav__label">(english)구매옵션 분석</label>
                </nav>
                <div class="syn__content syn__today">
                    ...
                    <div id="syn__order__pattern__wrapper" class="syn__content__wrapper syn__option syn__option__order">
                        <div class="fat__filter">
                            <div class="filter">
								...
								<nav class="filter__btn">
									...
									<label for="syn__order__pattern__filter__date__today" class="rectangle-radio-label">Today</label>
									...
									<label for="syn__order__pattern__filter__date__yesterday" class="rectangle-radio-label">Yesterday</label>
									...
									<label for="syn__order__pattern__filter__date__week" class="rectangle-radio-label">1 Week</label>
									...
									<label for="syn__order__pattern__filter__date__halfmonth" class="rectangle-radio-label">15 days</label>
									...
									<label for="syn__order__pattern__filter__date__month" class="rectangle-radio-label">1 month</label>
								</nav>
                            </div>
						</div>
                        <nav class="syn__order__filter">
							...
							<label for="syn__order__pattern__deatil__filter__gender__age" class="ellipse-radio-label">by Gender & Age</label>
							...
							<label for="syn__order__pattern__deatil__filter__gender" class="ellipse-radio-label">Gender</label>
							...
							<label for="syn__order__pattern__deatil__filter__age" class="ellipse-radio-label">By age group</label>
							...
							<label for="syn__order__pattern__deatil__filter__week" class="ellipse-radio-label">day</label>
							...
							<label for="syn__order__pattern__deatil__filter__time" class="ellipse-radio-label">by time zone</label>
							...
							<label for="syn__order__pattern__deatil__filter__payment" class="ellipse-radio-label">(english)결제수단별</label>
							...
							<label for="syn__order__pattern__deatil__filter__device" class="ellipse-radio-label">By device</label>
                        </nav>
                        ...
                        <div class="fat__filter">
                            <div class="filter">
                                ...
                                <nav class="filter__btn">
									...
									<label for="syn__order__option__filter__date__today" class="rectangle-radio-label">Today</label>
									...
									<label for="syn__order__option__filter__date__yesterday" class="rectangle-radio-label">Yesterday</label>
									...
									<label for="syn__order__option__filter__date__week" class="rectangle-radio-label">1 Week</label>
									...
									<label for="syn__order__option__filter__date__halfmonth" class="rectangle-radio-label">15 days</label>
									...
									<label for="syn__order__option__filter__date__month" class="rectangle-radio-label">1 month</label>
                                </nav>
                            </div>
