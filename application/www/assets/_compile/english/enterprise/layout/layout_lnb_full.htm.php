<?php /* Template_ 2.2.8 2020/08/31 15:57:15 /home/barrel-stage/application/www/assets/templet/enterprise/layout/layout_lnb_full.htm 000007085 */ ?>
<!DOCTYPE html>
...
<?php if($TPL_VAR["useFat"]===true){?>
    <script src="<?php echo $TPL_VAR["layoutCommon"]["templetSrc"]?>/js/common/dev_fat.js?version=<?php echo CLIENT_VERSION?>"></script>
<?php }?>
    <script>
        //set environment
