<?php /* Template_ 2.2.8 2020/08/31 15:57:04 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/mypage/recent_view/recent_view.htm 000003490 */ ?>
				...
				<div class="recent__goods devRecentViewDetail" data-id="{[id]}">
					...
					<div class="recent__goods__info">
						...
						<div class="recent__goods__price">
							...
							<span class="recent__goods__price--discount">[{[discount_rate]}%]</span>
							{[else]}
							<span class="recent__goods__price--cost"><?php echo $TPL_VAR["fbUnit"]["f"]?><em>{[dcprice]}</em><?php echo $TPL_VAR["fbUnit"]["b"]?></span>
							{[/if]}
							{[/if]}
