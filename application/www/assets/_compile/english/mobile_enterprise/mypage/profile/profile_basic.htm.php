<?php /* Template_ 2.2.8 2020/08/31 15:57:04 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/mypage/profile/profile_basic.htm 000028940 */ 
...
<?php if($TPL_VAR["isSnsJoin"]!=true){?>
            <dl class="br__join__list">
                <dt>Password</dt>
                <dd>
                    <button class="br__mypage__btn-s" id="devChangePassword" type="button">Change Password</button>
                </dd>
            </dl>
<?php }?>
...
<?php if($TPL_VAR["isSnsJoin"]!=true){?>
                    <div class="join__eamil">
                        <input class="join__input email-id" type="text" name="emailId" id="devEmailId" title="Email" value="<?php echo $TPL_VAR["mail"][ 0]?>" <?php if($TPL_VAR["isSnsJoin"]){?> disabled <?php }?>/>
                        <span>@</span>
                        <input class="join__input email-info" type="text" name="emailHost" id="devEmailHost" title="Email" value="<?php echo $TPL_VAR["mail"][ 1]?>" <?php if($TPL_VAR["isSnsJoin"]){?> disabled <?php }?>/>
                    </div>
...
<?php }else{?>
                    <div class="join__eamil">
                        ...
                        <input class="join__input email-id" type="hidden" name="emailId" id="devEmailId" title="Email" value="<?php echo $TPL_VAR["mail"][ 0]?>"/>
                        <span>@</span>
                        <span style="width:60px;"><?php echo $TPL_VAR["mail"][ 1]?></span>
                        <input class="join__input email-info" type="hidden" name="emailHost" id="devEmailHost" title="Email" value="<?php echo $TPL_VAR["mail"][ 1]?>"/>
                    </div>
<?php }?>
            ...
            <dl class="br__join__list">
                ...
                <dd>
                    <div class="join__phone">
                        ...
                        <input class="join__input join__phone-second" name="pcs2" value="<?php echo $TPL_VAR["pcs"][ 1]?>" type="text" maxlength="4"/>
                        <span class="join__phone-hyphen"></span>
            ...
            <dl class="br__join__add">
                <dt class="br__join__add-title">Birth</dt>
                <dd>
<?php if(empty($TPL_VAR["birthdayArr"])){?>
                    <div class="br__find-user__label">
                        <label><input type="radio" name="birthdayDiv" data-type="" value="1" checked><span>solar calendar</span></label>
                        <label><input type="radio" name="birthdayDiv" data-type="" value="0" ><span>lunar calendar</span></label>
                    </div>
