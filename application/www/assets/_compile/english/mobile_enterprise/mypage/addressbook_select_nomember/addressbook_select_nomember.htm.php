<?php /* Template_ 2.2.8 2020/08/31 15:57:04 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/mypage/addressbook_select_nomember/addressbook_select_nomember.htm 000007233 */ ?>
...
<?php }?>
            ...
            <!--<dl class="br__join__list">-->
                  ...
                  <!--<dd>-->
                        <!--<div class="join__phone ">-->
                              ...
                              <!--</select>-->
                              <!--<span class="join__phone-hyphen"></span>-->
                              <!--<input class="join__input  join__phone-second" type="text" name="tel2" value="" id="devTel2" title="Please enter the middle section of the phone number">-->
                              <!--<span class="join__phone-hyphen"></span>-->
                              <!--<input class="join__input join__phone-third" type="text" name="tel3" value="" id="devTel3" title="Please enter the last section of the phone number">-->
                        <!--</div>-->
                  <!--</dd>-->
            <!--</dl>-->
      </form>
      <div class="br__login__info add-manage">
            <div class="information__btn">
                  <button class="information__btn__join" id="devAddressBookPopColseBtn" data-oid="<?php echo $TPL_VAR["oid"]?>">Cancel</button>
