<?php /* Template_ 2.2.8 2020/08/31 15:57:05 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/shop/infoinput/infoinput_non_member_global.htm 000009744 */ 
...
<?php }}?>
                ...
                <div class="info-buyer__form info-buyer__form--email">
                    ...
                    <div class="flexWrap">
                        <input type="text" id="devBuyerEmailId" name="devBuyerEmailId" class="info-buyer__form__input" value="<?php echo $TPL_VAR["buyerEmailId"]?>" title="Email">
                        <span class="hyphen_2">@</span>
                        <input type="text" id="devBuyerEmailHost" name="devBuyerEmailHost" class="info-buyer__form__input" value="<?php echo $TPL_VAR["buyerEmailHost"]?>" title="Email">
                    </div>
                </div>
                <div class="info-buyer__form">
                    <label for="devBuyerName" class="info-buyer__form__label">Order Password</label>
                    <input id="devOrderPassword" name="devOrderPassword" class="info-buyer__form__input"  type="password"  title="Order Password" maxlength="16">
                ...
                <div class="info-buyer__form">
                    ...
                    <input id="devOrderPasswordCompare" name="devOrderPasswordCompare" class="info-buyer__form__input"  type="password"  title="order password comfirmation" maxlength="16">
    ...
    <div class="infoinput__toggle">
        ...
        <div class="infoinput__toggle__content">
            <div class="info-buyer devRecipientContents">
                <div class="info-buyer__form">
                    <input type="checkbox" class="info-buyer__form__check devSameBuyerInfo" id="sam-buyer-checkbox"><label for="sam-buyer-checkbox">Same as the orderer</label>
                </div>
                <div class="info-buyer__form">
                    <label for="devRecipientName" class="info-buyer__form__label">Name</label>
                    <input type="text" id="devRecipientName" name="devRecipientName" class="devRecipientName" title="Recipient Name">
                </div>
                <!-- @TODO 주소 입력 형식 변경 -->
