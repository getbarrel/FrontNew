<?php /* Template_ 2.2.8 2020/08/31 15:56:55 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/brand/application_form/application_form.htm 000004789 */ ?>
<section class="br__apply">
    ...
    <div class="apply__btn">
        <a href="#" id="goIndivisual" class="apply__btn--personal">
            <p class="txt">개인<span>신청하러 가기</span></p>
        </a>
        <a href="#" id="goGroup" class="apply__btn--group">
    ...
    <section class="inquiry-info">
        ...
        <p class="inquiry-info__desc">
            내가 신청한 신청서를 조회할 수 있습니다.<br>잘못 기입한 사항이 있으면 수정할 수 있으니<br>수정 가능기간(01. 02 ~ 01. 09) 을 확인 후 수정 바랍니다.
        </p>
