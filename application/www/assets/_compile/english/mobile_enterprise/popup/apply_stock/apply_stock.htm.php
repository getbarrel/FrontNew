<?php /* Template_ 2.2.8 2021/10/20 09:19:57 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/popup/apply_stock/apply_stock.htm 000005670 */ 
...
<div class="goods-alarm">
    <form id="devReStock">
        ...
        <div class="goods-alarm__scroll">
            <h3 class="goods-alarm__title">Request for restock <br>notification!</h3>
            <p class="goods-alarm__desc">SMS will be sent to registered mobile number <br>upon restock of the product</p>
...
<?php if($TPL_VAR["discount_rate"]> 0){?><span class="goods-alarm__goods__discount">[<?php echo $TPL_VAR["discount_rate"]?>%]</span><?php }?>
                    </div>
                </div>
            </div>
...
<?php if(is_array($TPL_R2=$TPL_V1["optionDetailList"])&&!empty($TPL_R2)){$TPL_I2=-1;foreach($TPL_R2 as $TPL_V2){$TPL_I2++;?>
                    <li class="goods-alarm__options__box">
                        ...
                        <label class="goods-alarm__options__btn" for="alarm_option<?php echo $TPL_I1?><?php echo $TPL_I2?>"><?php echo $TPL_V2["m_shot_option_div"]?></label>
                    </li>
<?php }}?>
<?php }}?>
                    <!--
...
<?php }?>
            ...
            <ul class="goods-alarm__notice">
                <li class="goods-alarm__notice__desc">Products that have completed SMS requests will be saved as a list of restock notifications.</li>
                <li class="goods-alarm__notice__desc">Product information, such as price and option configuration of SMS requested products, may change, so please check product information upon re-purchase.</li>
                <li class="goods-alarm__notice__desc">· 재입고 SMS알림은 요청일로부터 15일간 유효합니다.</li>
            </ul>
