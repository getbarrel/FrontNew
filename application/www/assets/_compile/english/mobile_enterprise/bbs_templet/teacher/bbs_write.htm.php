<?php /* Template_ 2.2.8 2020/10/27 11:47:04 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/bbs_templet/teacher/bbs_write.htm 000009943 */ 
...
<section class="br__mypage br__join br__myInquiry br__teacher">
    <div class="apply">
        <div class="br__mypage__pass">
            <p class="pass-title">Teacher member recruitment</p>
        </div>
...
<?php if($TPL_VAR["board_file_yn"]=='Y'){?>
                <div class="myInquiry__write-upload">
                    <p class="apply__label">Attachment</p>
...
<?php }?>
                <div class="apply__secret">
                    <p class="apply__label">Secret Mode</p>
                    <div>
                ...
                <div class="apply__btn">
                    <div class="information__btn">
                        <button type="button" class="apply__btn__cancel btn-lg btn-dark-line" id="devBbsRegCancel">Cancel</button>
                        <button type="button" class="apply__btn__submit" id="devBbsRegSubmit">Submit</button>
                    </div>
                </div>
            </div>
