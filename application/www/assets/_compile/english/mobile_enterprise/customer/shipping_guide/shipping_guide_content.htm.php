<?php /* Template_ 2.2.8 2021/12/02 15:33:19 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/customer/shipping_guide/shipping_guide_content.htm 000010501 */ ?>
<div class="gform shippingGuide">
    <!---->
    <div class="gform__common">
        <h3 class="gform__common__top">Barrel Uses EMS at the post office</h3>
<?php if($TPL_VAR["langType"]=='korean'){?>
        <dl class="gform__info">
            ...
            <dt class="gform__info__title eng-hidden">Shipping cost</dt>
            <dd class="gform__info__detail eng-hidden">
                Overseas shipping fee<br>will be charged<br>
            </dd>
            <dt class="gform__info__title">Delivery period</dt>
            <dd class="gform__info__detail">
                (english)1-3일 소요(평일기준)<br>여름시즌 : 2-5일 소요(평일기준)
            </dd>
        </dl>
<?php }else{?>
        <p class="gform__info">
...
<?php if($TPL_VAR["langType"]=='korean'){?>
    ...
    <!--<p class="gform__common__desc">
        (english)배송 준비중 상태에서는 취소가 불가합니다.<br>단, <em class=""gform__common__desc--point"">오전 9시 이전 주문건의 경우 오전 10시까지,<br>오후 2시 이전 주문건의경우 오후 3시까지<br></em>고객센터를 통해 취소 접수가 가능할 수 있으니<br>취소를 요청하는 경우 고객센터로 연락 부탁드립니다.
    </p>-->
<?php }else{?>
...
<?php }?>
    ...
    <div class="gform__common">
        <h3 class="gform__common__top">Cancellation Guidance</h3>
        <dl class="gform__info">
            ...
            <dd class="gform__info__detail">
                when packing of goods is complete<br>Cancellation, non-changeable
            </dd>
            <dt class="gform__info__title">
