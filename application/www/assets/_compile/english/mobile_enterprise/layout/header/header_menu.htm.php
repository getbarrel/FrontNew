<?php /* Template_ 2.2.8 2021/10/06 17:02:05 /home/barrel-stage/application/www/assets/mobile_templet/mobile_enterprise/layout/header/header_menu.htm 000021923 */ ?>
<style>
    ...
    .crema-type .br__drawer__sns .sns-box__list {width:20%; text-align:center;}
    ...
    .crema-type .br__drawer__sns .sns-box__list a {background: url('/assets/mobile_templet/mobile_enterprise/images/layout/icon_drawer_sns2.png') no-repeat 0 0; background-size:17.05rem 3rem; display:inline-block;}
    .crema-type .br__drawer__sns .sns-box__list--facebook a {background-position-x:-10.55rem;}
    .crema-type .br__drawer__sns .sns-box__list--youtube a {background-position-x:-14rem;}
    .crema-type .br__drawer__sns .sns-box__list--blog a {background-position-x:-3.5rem;}
    .crema-type .br__drawer__sns .sns-box__list--pola a {background-position-x:-7.05rem;}
...
<?php }else{?>
                <div class="user-info">
                    <a href="/member/login" class="panel__btn__login">Sign in</a>
                    <!-- <a href="/member/joinInput" class="panel__btn__join">Join</a> -->
					<a href="/member/login?kakao=one" class="panel__btn__join">Join</a>
...
<?php if($TPL_VAR["langType"]=='korean'){?>
                    ...
                    <li class="sns-box__list sns-box__list--pola"><a href="#">폴라</a></li>
<?php }?>
                </ul>
            </div>
        </section>
...
<?php if($TPL_VAR["langType"]=='korean'){?>
                        <img src="/assets/mobile_templet/mobile_enterprise/dist/images/layout/icon_drawer_global_kr.png" alt="국기">한국어
<?php }elseif($TPL_VAR["langType"]=='english'){?>
                        <img src="/assets/mobile_templet/mobile_enterprise/dist/images/layout/icon_drawer_global_en.png" alt="국기">EN
<?php }else{?>
                        <img src="/assets/mobile_templet/mobile_enterprise/dist/images/layout/icon_drawer_global_cn.png" alt="국기">CN
<?php }?>
                    </button>
                    <ul class="global-box__select__list">
                        <li><a href="//www.getbarrel.com/"><img src="/assets/mobile_templet/mobile_enterprise/dist/images/layout/icon_drawer_global_kr.png" alt="국기">한국어</a></li>
