...
$(document).ready(function () {
    ...
    var myInquiryList = common.ajaxList2();
    ...
    $('#devMyInquiryContent').on('click', '[devBbsIx]', function () {
        var requestData = {};
        var modal_title = '1:1 문의 내역';

        if(common.langType == 'english') {
            modal_title = '1:1 Inquiries';
        }
        requestData['bbs_ix'] = $(this).attr('devBbsIx');
        common.util.modal.open('ajax', modal_title, '/mypage/myInquiryDetail', requestData);
    });
