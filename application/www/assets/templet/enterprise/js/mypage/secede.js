...
$(function () {
    ...
    common.lang.load('secede.common.withdraw.has.kkumin.account', '현재 정산예정 주문건이 있으므로 회원탈퇴가 불가능 합니다.');
    ...
    common.form.init(
        ...
        function (res) {
            ...
            } else if(res.result == 'hasKkuminOrder') {
                common.noti.alert(common.lang.get('secede.common.withdraw.has.kkumin.account'));
