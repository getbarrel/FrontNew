...
if (PHP_SAPI === 'cli' || defined('STDIN')) {
    ...
    define('AUTO_GEN_BASEURL',
        (((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") || (!empty($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO']
        == 'https' || !empty($_SERVER['HTTP_X_FORWARDED_SSL']) && $_SERVER['HTTP_X_FORWARDED_SSL'] == 'on')) ? "https" : "http")
        ."://".$_SERVER['HTTP_HOST'].'/'
    );
}
// Set Environment
...
define('FCPATH', DOCUMENT_ROOT.DIRECTORY_SEPARATOR);
