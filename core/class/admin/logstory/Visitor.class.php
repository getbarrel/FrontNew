    ...
    function VisitorUpdate() {
        ...
        if ($db->total > 0) {
            ...
            $sql = "insert into " . TBL_LOGSTORY_VISITORINFO . " 
						...
						values 
						('" . $mData->VisitDate . "','" . $mData->agent_type . "', '" . $mData->VISITORID . "','" . $mData->fREMOTE_ADDR . "','" . $mData->fHTTP_USER_AGENT . "','" . $mData->fRefererID . "','" . $mData->KID . "',1, '" . ($mData->OVER_TURE ? "1" : "0") . "','" . $_COOKIE["VISITORDATE"] . "," . $_COOKIE["PHPSESSID"] . "," . $_COOKIE["VID"] . "," . $_COOKIE["LAST_CON_TIME"] . "', NOW()) ";
        }
